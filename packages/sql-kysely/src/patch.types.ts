...
declare module "kysely" {
    export interface AlterTableColumnAlteringBuilder
        extends Effect.Effect<void, SqlError> {}
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    export interface CreateIndexBuilder<C>
        extends Effect.Effect<void, SqlError> {}
    export interface CreateSchemaBuilder
        extends Effect.Effect<void, SqlError> {}
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    export interface CreateTableBuilder<TB, C>
        extends Effect.Effect<void, SqlError> {}
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    export interface SelectQueryBuilder<DB, TB, O>
        extends Effect.Effect<Array<Simplify<O>>, SqlError> {}
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    export interface InsertQueryBuilder<DB, TB, O>
        extends Effect.Effect<Array<Simplify<O>>, SqlError> {}
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    export interface UpdateQueryBuilder<DB, UT, TB, O>
        extends Effect.Effect<Array<Simplify<O>>, SqlError> {}
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    export interface DeleteQueryBuilder<DB, TB, O>
        extends Effect.Effect<Array<Simplify<O>>, SqlError> {}
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    export interface WheneableMergeQueryBuilder<DB, TT, ST, O>
        extends Effect.Effect<Array<Simplify<O>>, SqlError> {}
}
