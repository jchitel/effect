...
> extends Pipeable {
     ...
     * be executed.
     */
    addRequirement<Requirement>(): AiTool<
        Name,
        Parameters,
        Success,
        Failure,
    ...
    annotate<I, S>(
        ...
        value: S,
    ): AiTool<Name, Parameters, Success, Failure, Requirements>;
 ...
 * @category Guards
 */
export const isAiTool = (u: unknown): u is AiTool<any, any, any, any, any> =>
 ...
 * @category Utility Types
 */
export type ParametersSchema<Tool> =
    Tool extends AiTool<
        infer _Name,
        infer _Parameters,
        infer _Success,
 ...
 * @category Utility Types
 */
export type SuccessSchema<Tool> =
    Tool extends AiTool<
        infer _Name,
        infer _Parameters,
        infer _Success,
 ...
 * @category Utility Types
 */
export type FailureSchema<Tool> =
    Tool extends AiTool<
        infer _Name,
        infer _Parameters,
        infer _Success,
 ...
 * @category Utility Types
 */
export type ToHandler<Tool extends Any> =
    Tool extends AiTool<
        infer _Name,
        infer _Parameters,
        infer _Success,
 ...
 */
export class Title extends Context_.Tag("@effect/ai/AiTool/Title")<
    Title,
    string
>() {}
 ...
 * @category Annotations
 */
export class Readonly extends Context_.Reference<Readonly>()(
    "@effect/ai/AiTool/Readonly",
    {
 ...
 * @category Annotations
 */
export class Destructive extends Context_.Reference<Destructive>()(
    "@effect/ai/AiTool/Destructive",
    {
 ...
 * @category Annotations
 */
export class Idempotent extends Context_.Reference<Idempotent>()(
    "@effect/ai/AiTool/Idempotent",
    {
        defaultValue: constFalse,
    },
) {}
 ...
 * @category Annotations
 */
export class OpenWorld extends Context_.Reference<OpenWorld>()(
    "@effect/ai/AiTool/OpenWorld",
    {
        defaultValue: constTrue,
    },
) {}
