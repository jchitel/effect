 ...
 * @category Context
 */
export class AiEmbeddingModel extends Context.Tag(
    "@effect/ai/AiEmbeddingModel",
)<AiEmbeddingModel, AiEmbeddingModel.Service>() {}
...
export declare namespace AiEmbeddingModel {
    ...
    export interface Service {
        readonly embed: (
            input: string,
        ) => Effect.Effect<Array<number>, AiError>;
    }
    ...
    Effect.gen(function* () {
        ...
        function embed(input: string) {
            ...
            return Option.match(cache, {
                ...
                Effect.withSpan("AiEmbeddingModel.embed", {
