...
export class RequestServerToolUseBlockType extends S.Literal(
    "server_tool_use",
) {}

export class RequestServerToolUseBlock extends S.Struct({
    cache_control: S.optionalWith(S.Union(CacheControlEphemeral, S.Null), {
        nullable: true,
    }),
...
export class RequestWebSearchResultBlockType extends S.Literal(
    "web_search_result",
) {}
...
export class RequestWebSearchToolResultErrorType extends S.Literal(
...
export class RequestWebSearchToolResultBlockType extends S.Literal(
...
export class RequestWebSearchToolResultBlock extends S.Struct({
    ...
    tool_use_id: S.String.pipe(
        S.pattern(new RegExp("^srvtoolu_[a-zA-Z0-9_]+$")),
    ),
    type: RequestWebSearchToolResultBlockType,
}) {}

export class RequestCharLocationCitationType extends S.Literal(
    "char_location",
) {}
...
export class RequestCharLocationCitation extends S.Struct({
    ...
    document_title: S.Union(
        S.String.pipe(S.minLength(1), S.maxLength(255)),
        S.Null,
    ),
...
export class RequestPageLocationCitationType extends S.Literal(
    "page_location",
) {}
...
export class RequestContentBlockLocationCitationType extends S.Literal(
...
export class RequestWebSearchResultLocationCitationType extends S.Literal(
...
export class RequestDocumentBlock extends S.Struct({
    ...
    context: S.optionalWith(S.Union(S.String.pipe(S.minLength(1)), S.Null), {
        nullable: true,
    }),
    source: S.Union(
        Base64PDFSource,
    ...
    title: S.optionalWith(
        S.Union(S.String.pipe(S.minLength(1), S.maxLength(500)), S.Null),
        { nullable: true },
    ),
...
export class RequestRedactedThinkingBlockType extends S.Literal(
    "redacted_thinking",
) {}
...
export class Metadata extends S.Struct({
    user_id: S.optionalWith(S.Union(S.String.pipe(S.maxLength(256)), S.Null), {
        nullable: true,
    }),
}) {}
...
export class InputSchema extends S.Struct({
    properties: S.optionalWith(
        S.Union(S.Record({ key: S.String, value: S.Unknown }), S.Null),
        { nullable: true },
    ),
    required: S.optionalWith(S.Union(S.Array(S.String), S.Null), {
        nullable: true,
    }),
...
export class TextEditor20250429Name extends S.Literal(
...
export class WebSearchTool20250305Type extends S.Literal(
    "web_search_20250305",
) {}
...
export class UserLocation extends S.Struct({
    city: S.optionalWith(
        S.Union(S.String.pipe(S.minLength(1), S.maxLength(255)), S.Null),
        { nullable: true },
    ),
    country: S.optionalWith(
        S.Union(S.String.pipe(S.minLength(2), S.maxLength(2)), S.Null),
        { nullable: true },
    ),
    region: S.optionalWith(
        S.Union(S.String.pipe(S.minLength(1), S.maxLength(255)), S.Null),
        { nullable: true },
    ),
    timezone: S.optionalWith(
        S.Union(S.String.pipe(S.minLength(1), S.maxLength(255)), S.Null),
        { nullable: true },
    ),
...
export class WebSearchTool20250305 extends S.Struct({
    allowed_domains: S.optionalWith(S.Union(S.Array(S.String), S.Null), {
        nullable: true,
    }),
    blocked_domains: S.optionalWith(S.Union(S.Array(S.String), S.Null), {
        nullable: true,
    }),
    cache_control: S.optionalWith(S.Union(CacheControlEphemeral, S.Null), {
        nullable: true,
    }),
    max_uses: S.optionalWith(S.Union(S.Int.pipe(S.greaterThan(0)), S.Null), {
        nullable: true,
    }),
    name: WebSearchTool20250305Name,
    type: WebSearchTool20250305Type,
    user_location: S.optionalWith(S.Union(UserLocation, S.Null), {
        nullable: true,
    }),
}) {}
...
export class ResponseCharLocationCitationType extends S.Literal(
    "char_location",
) {}
...
export class ResponsePageLocationCitationType extends S.Literal(
    "page_location",
) {}
...
export class ResponseContentBlockLocationCitationType extends S.Literal(
    "content_block_location",
) {}
...
export class ResponseWebSearchResultLocationCitationType extends S.Literal(
    "web_search_result_location",
) {}
...
export class ResponseServerToolUseBlockType extends S.Literal(
    "server_tool_use",
) {}
...
export class ResponseWebSearchToolResultErrorType extends S.Literal(
    "web_search_tool_result_error",
) {}
...
export class ResponseWebSearchResultBlockType extends S.Literal(
    "web_search_result",
) {}
...
export class ResponseWebSearchToolResultBlockType extends S.Literal(
    "web_search_tool_result",
) {}
...
export class ResponseRedactedThinkingBlockType extends S.Literal(
    "redacted_thinking",
) {}
...
export class Usage extends S.Struct({
    cache_creation_input_tokens: S.NullOr(
        S.Union(S.Int.pipe(S.greaterThanOrEqualTo(0)), S.Null),
    ),
    cache_read_input_tokens: S.NullOr(
        S.Union(S.Int.pipe(S.greaterThanOrEqualTo(0)), S.Null),
    ),
...
export class InvalidRequestErrorType extends S.Literal(
...
export class AuthenticationErrorType extends S.Literal(
...
export class CreateMessageBatchParams extends S.Class<CreateMessageBatchParams>(
    ...
    requests: S.Array(MessageBatchIndividualRequestParams).pipe(
        S.minItems(1),
        S.maxItems(10000),
    ),
}) {}
...
export class DeleteMessageBatchResponseType extends S.Literal(
...
export class BetaRequestServerToolUseBlockType extends S.Literal(
    "server_tool_use",
) {}

export class BetaRequestServerToolUseBlock extends S.Struct({
    cache_control: S.optionalWith(S.Union(BetaCacheControlEphemeral, S.Null), {
        nullable: true,
    }),
    id: S.String.pipe(S.pattern(new RegExp("^srvtoolu_[a-zA-Z0-9_]+$"))),
    input: S.Record({ key: S.String, value: S.Unknown }),
...
export class BetaRequestWebSearchResultBlockType extends S.Literal(
    "web_search_result",
) {}
...
export class BetaRequestWebSearchToolResultErrorType extends S.Literal(
    "web_search_tool_result_error",
) {}
...
export class BetaRequestWebSearchToolResultBlockType extends S.Literal(
    "web_search_tool_result",
) {}
...
export class BetaRequestCodeExecutionToolResultErrorType extends S.Literal(
...
export class BetaRequestCodeExecutionOutputBlockType extends S.Literal(
...
export class BetaRequestCodeExecutionResultBlockType extends S.Literal(
...
export class BetaRequestCodeExecutionToolResultBlockType extends S.Literal(
...
export class BetaRequestCharLocationCitationType extends S.Literal(
    "char_location",
) {}
...
export class BetaRequestPageLocationCitationType extends S.Literal(
    "page_location",
) {}
...
export class BetaRequestContentBlockLocationCitationType extends S.Literal(
    "content_block_location",
) {}
...
export class BetaRequestWebSearchResultLocationCitationType extends S.Literal(
    "web_search_result_location",
) {}
...
export class BetaRequestMCPToolResultBlockType extends S.Literal(
    "mcp_tool_result",
) {}
...
export class BetaBase64PDFSourceMediaType extends S.Literal(
    "application/pdf",
) {}
...
export class BetaRequestRedactedThinkingBlockType extends S.Literal(
    "redacted_thinking",
) {}
...
export class BetaRequestContainerUploadBlockType extends S.Literal(
    "container_upload",
) {}
...
export class BetaRequestMCPServerToolConfiguration extends S.Struct({
    allowed_tools: S.optionalWith(S.Union(S.Array(S.String), S.Null), {
        nullable: true,
    }),
...
export class BetaRequestMCPServerURLDefinition extends S.Struct({
    authorization_token: S.optionalWith(S.Union(S.String, S.Null), {
        nullable: true,
    }),
    name: S.String,
    tool_configuration: S.optionalWith(
        S.Union(BetaRequestMCPServerToolConfiguration, S.Null),
        { nullable: true },
    ),
...
export class BetaComputerUseTool20241022Type extends S.Literal(
    "computer_20241022",
) {}
...
export class BetaTextEditor20241022Name extends S.Literal(
    "str_replace_editor",
) {}

export class BetaTextEditor20241022Type extends S.Literal(
...
export class BetaComputerUseTool20250124Type extends S.Literal(
    "computer_20250124",
) {}
...
export class BetaTextEditor20250124Name extends S.Literal(
    "str_replace_editor",
) {}

export class BetaTextEditor20250124Type extends S.Literal(
...
export class BetaTextEditor20250429Name extends S.Literal(
    "str_replace_based_edit_tool",
) {}

export class BetaTextEditor20250429Type extends S.Literal(
...
export class BetaWebSearchTool20250305Type extends S.Literal(
    "web_search_20250305",
) {}
...
export class BetaWebSearchTool20250305 extends S.Struct({
    ...
    user_location: S.optionalWith(S.Union(BetaUserLocation, S.Null), {
        nullable: true,
    }),
}) {}

export class BetaCodeExecutionTool20250522Name extends S.Literal(
    "code_execution",
) {}

export class BetaCodeExecutionTool20250522Type extends S.Literal(
...
export class BetaResponseCharLocationCitationType extends S.Literal(
    "char_location",
) {}
...
export class BetaResponsePageLocationCitationType extends S.Literal(
    "page_location",
) {}
...
export class BetaResponseContentBlockLocationCitationType extends S.Literal(
    "content_block_location",
) {}
...
export class BetaResponseWebSearchResultLocationCitationType extends S.Literal(
    "web_search_result_location",
) {}
...
export class BetaResponseServerToolUseBlockType extends S.Literal(
    "server_tool_use",
) {}
...
export class BetaResponseWebSearchToolResultErrorType extends S.Literal(
    "web_search_tool_result_error",
) {}
...
export class BetaResponseWebSearchResultBlockType extends S.Literal(
    "web_search_result",
) {}
...
export class BetaResponseWebSearchToolResultBlockType extends S.Literal(
    "web_search_tool_result",
) {}
...
export class BetaResponseCodeExecutionToolResultErrorType extends S.Literal(
    "code_execution_tool_result_error",
) {}
...
export class BetaResponseCodeExecutionOutputBlockType extends S.Literal(
    "code_execution_output",
) {}
...
export class BetaResponseCodeExecutionResultBlockType extends S.Literal(
    "code_execution_result",
) {}
...
export class BetaResponseCodeExecutionToolResultBlockType extends S.Literal(
    "code_execution_tool_result",
) {}
...
export class BetaResponseMCPToolUseBlockType extends S.Literal(
    "mcp_tool_use",
) {}
...
export class BetaResponseMCPToolResultBlockType extends S.Literal(
    "mcp_tool_result",
) {}
...
export class BetaResponseContainerUploadBlockType extends S.Literal(
    "container_upload",
) {}
...
export class BetaResponseRedactedThinkingBlockType extends S.Literal(
    "redacted_thinking",
) {}
...
export class BetaInvalidRequestErrorType extends S.Literal(
    "invalid_request_error",
) {}
...
export class BetaAuthenticationErrorType extends S.Literal(
    "authentication_error",
) {}
...
export class BetaCreateMessageBatchParams extends S.Class<BetaCreateMessageBatchParams>(
    ...
    requests: S.Array(BetaMessageBatchIndividualRequestParams).pipe(
        S.minItems(1),
        S.maxItems(10000),
    ),
}) {}
...
export class BetaDeleteMessageBatchResponseType extends S.Literal(
    "message_batch_deleted",
) {}
    ...
    return {
        ...
        messagesPost: (options) =>
            HttpClientRequest.make("POST")(`/v1/messages`).pipe(
                ...
                (req) =>
                    Effect.orDie(
                        HttpClientRequest.bodyJson(req, options.payload),
                    ),
            ...
            HttpClientRequest.make("POST")(`/v1/complete`).pipe(
                HttpClientRequest.setHeaders({
                    "anthropic-version":
                        options.params?.["anthropic-version"] ?? undefined,
                    "anthropic-beta":
                        options.params?.["anthropic-beta"] ?? undefined,
                }),
                (req) =>
                    Effect.orDie(
                        HttpClientRequest.bodyJson(req, options.payload),
        ...
        modelsList: (options) =>
            HttpClientRequest.make("GET")(`/v1/models`).pipe(
                ...
                HttpClientRequest.setHeaders({
                    "anthropic-version":
                        options?.["anthropic-version"] ?? undefined,
                        ...
                        (httpClient) =>
                            Effect.flatMap(
                                ...
                                HttpClientResponse.matchStatus({
                                    ...
                                    "4xx": (r) =>
                                        decodeError(r, BetaErrorResponse),
                                    orElse: (response) =>
                                        unexpectedStatus(request, response),
                                }),
                            ),
        ...
        betaDownloadFileV1FilesFileIdContentGet: (fileId, options) =>
            HttpClientRequest.make("GET")(
                `/v1/files/${fileId}/content?beta=true`,
            ).pipe(
                HttpClientRequest.setHeaders({
                    "anthropic-beta": options?.["anthropic-beta"] ?? undefined,
                    "anthropic-version":
...
export interface Client {
    ...
    readonly messagesCountTokensPost: (options: {
        readonly params?:
            | typeof MessagesCountTokensPostParams.Encoded
            | undefined;
    ...
    readonly uploadFileV1FilesPost: (options: {
        readonly params?:
            | typeof UploadFileV1FilesPostParams.Encoded
            | undefined;
    ...
    readonly betaMessageBatchesPost: (options: {
        readonly params?:
            | typeof BetaMessageBatchesPostParams.Encoded
            | undefined;
