...
): AiModel.AiModel<AiLanguageModel.AiLanguageModel, AnthropicClient> =>
...
export const make = Effect.fnUntraced(function* (options: {
    ...
    const makeRequest = Effect.fnUntraced(function* (
        ...
        let tool_choice: typeof Generated.ToolChoice.Encoded | undefined =
            undefined;
        if (useStructured) {
                                    ...
                                    case "FilePart": {
                                        if (
                                            ...
                                            return yield* new AiError({
                                                ...
                                                method,
                                                description:
                                                    "AnthropicLanguageModel only supports PDF file inputs",
                                            });
                                        }
                                        content.push({
                                            type: "document",
...
const makeResponse = Effect.fnUntraced(function* (response: Generated.Message) {
