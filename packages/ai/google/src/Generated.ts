...
export class Part extends S.Class<Part>("Part")({
     ...
     * Result of executing the `ExecutableCode`.
     */
    codeExecutionResult: S.optionalWith(CodeExecutionResult, {
        nullable: true,
    }),
    /**
...
export class VoiceConfig extends S.Class<VoiceConfig>("VoiceConfig")({
     ...
     */
    prebuiltVoiceConfig: S.optionalWith(PrebuiltVoiceConfig, {
        nullable: true,
    }),
}) {}
...
export class CitationMetadata extends S.Class<CitationMetadata>(
     ...
     */
    citationSources: S.optionalWith(S.Array(CitationSource), {
        nullable: true,
    }),
}) {}
 ...
 * Grounding support.
 */
export class GroundingSupport extends S.Class<GroundingSupport>(
    "GroundingSupport",
)({
    /**
...
export class GroundingMetadata extends S.Class<GroundingMetadata>(
     ...
     */
    groundingChunks: S.optionalWith(S.Array(GroundingChunk), {
        nullable: true,
    }),
    /**
     * List of grounding support.
     */
    groundingSupports: S.optionalWith(S.Array(GroundingSupport), {
        nullable: true,
    }),
    /**
     * Metadata related to retrieval in the grounding flow.
...
export class Modality extends S.Literal(
...
export class SemanticRetrieverConfig extends S.Class<SemanticRetrieverConfig>(
     ...
     */
    metadataFilters: S.optionalWith(S.Array(MetadataFilter), {
        nullable: true,
    }),
    /**
...
export class CachedContent extends S.Class<CachedContent>("CachedContent")({
     ...
     */
    usageMetadata: S.optionalWith(CachedContentUsageMetadata, {
        nullable: true,
    }),
}) {}
 ...
 * Veo response.
 */
export class GenerateVideoResponse extends S.Class<GenerateVideoResponse>(
     ...
     */
    raiMediaFilteredReasons: S.optionalWith(S.Array(S.String), {
        nullable: true,
    }),
}) {}
...
export class PredictLongRunningResponse extends S.Class<PredictLongRunningResponse>(
     ...
     */
    generateVideoResponse: S.optionalWith(GenerateVideoResponse, {
        nullable: true,
    }),
}) {}
 ...
 */
export class QueryCorpusRequest extends S.Class<QueryCorpusRequest>(
    "QueryCorpusRequest",
)({
    /**
 ...
 */
export class ChunkState extends S.Literal(
    "STATE_UNSPECIFIED",
 ...
 */
export class QueryCorpusResponse extends S.Class<QueryCorpusResponse>(
    "QueryCorpusResponse",
)({
    /**
     * The relevant chunks.
 ...
 */
export class QueryDocumentRequest extends S.Class<QueryDocumentRequest>(
 ...
 */
export class QueryDocumentResponse extends S.Class<QueryDocumentResponse>(
 ...
 */
export class ListChunksResponse extends S.Class<ListChunksResponse>(
    "ListChunksResponse",
)({
    /**
 ...
 */
export class CreateChunkRequest extends S.Class<CreateChunkRequest>(
    "CreateChunkRequest",
)({
    /**
 ...
 */
export class BatchCreateChunksRequest extends S.Class<BatchCreateChunksRequest>(
 ...
 */
export class BatchCreateChunksResponse extends S.Class<BatchCreateChunksResponse>(
 ...
 */
export class UpdateChunkRequest extends S.Class<UpdateChunkRequest>(
    "UpdateChunkRequest",
)({
    /**
 ...
 */
export class BatchUpdateChunksRequest extends S.Class<BatchUpdateChunksRequest>(
 ...
 */
export class BatchUpdateChunksResponse extends S.Class<BatchUpdateChunksResponse>(
 ...
 */
export class DeleteChunkRequest extends S.Class<DeleteChunkRequest>(
    "DeleteChunkRequest",
)({
    /**
 ...
 */
export class BatchDeleteChunksRequest extends S.Class<BatchDeleteChunksRequest>(
...
export interface Client {
    ...
    readonly UpdateCachedContent: (
        ...
        options: {
            readonly params?:
                | typeof UpdateCachedContentParams.Encoded
                | undefined;
    ...
    readonly UpdateCorpus: (
        corpus: string,
        options: {
            readonly params: typeof UpdateCorpusParams.Encoded;
            readonly payload: typeof Corpus.Encoded;
        },
    ) => Effect.Effect<
        typeof Corpus.Type,
        HttpClientError.HttpClientError | ParseError
    ...
    readonly QueryCorpus: (
        ...
        typeof QueryCorpusResponse.Type,
        HttpClientError.HttpClientError | ParseError
    >;
    /**
    ...
    readonly UpdateDocument: (
        ...
        document: string,
        options: {
            readonly params: typeof UpdateDocumentParams.Encoded;
            readonly payload: typeof Document.Encoded;
        },
    ) => Effect.Effect<
        typeof Document.Type,
        HttpClientError.HttpClientError | ParseError
    ...
    readonly QueryDocument: (
        ...
        typeof QueryDocumentResponse.Type,
        HttpClientError.HttpClientError | ParseError
    >;
    /**
    ...
    readonly ListChunks: (
        ...
        typeof ListChunksResponse.Type,
        HttpClientError.HttpClientError | ParseError
    >;
    /**
     * Creates a `Chunk`.
    ...
    readonly BatchCreateChunks: (
        ...
        typeof BatchCreateChunksResponse.Type,
        HttpClientError.HttpClientError | ParseError
    >;
    /**
    ...
    readonly UpdateChunk: (
        ...
        chunk: string,
        options: {
            readonly params: typeof UpdateChunkParams.Encoded;
            readonly payload: typeof Chunk.Encoded;
        },
    ) => Effect.Effect<
        typeof Chunk.Type,
        HttpClientError.HttpClientError | ParseError
    ...
    readonly BatchUpdateChunks: (
        ...
        typeof BatchUpdateChunksResponse.Type,
        HttpClientError.HttpClientError | ParseError
    >;
    /**
