...
export const ProviderMetadataKey =
    "@effect/ai-google/GoogleGenerativeAiLanguageModel/ProviderMetadata";
...
export const resolveFinishReason = (
    finishReason: typeof CandidateFinishReason.Type,
): AiResponse.FinishReason => {
 ...
 * @internal
 */
export const jsonSchemaToOpenApi = (
    schema: JsonSchema7,
    ...
    if ("type" in schema && schema.type === "string") {
        ...
        if (stringSchema.format !== undefined)
