...
export class GuardrailConverseTextBlock extends Schema.Class<GuardrailConverseTextBlock>(
    ...
    qualifiers: Schema.optional(
        Schema.Array(
            Schema.Literal("guard_content", "grounding_source", "query"),
        ),
    ),
}) {}
...
export class GuardrailConfiguration extends Schema.Class<GuardrailConfiguration>(
    ...
    trace: Schema.optional(
        Schema.Literal("enabled", "disabled", "enabled_full"),
    ),
}) {}
...
export class ConverseStreamResponse extends Schema.Class<ConverseStreamResponse>(
    ...
    internalServerException: Schema.optional(
        Schema.Record({
            key: Schema.String,
            value: Schema.Unknown,
        }),
    ),
    modelStreamErrorException: Schema.optional(
        Schema.Record({
            key: Schema.String,
            value: Schema.Unknown,
        }),
    ),
    serviceUnavailableException: Schema.optional(
        Schema.Record({
            key: Schema.String,
            value: Schema.Unknown,
        }),
    ),
    throttlingException: Schema.optional(
        Schema.Record({
            key: Schema.String,
            value: Schema.Unknown,
        }),
    ),
    validationException: Schema.optional(
        Schema.Record({
            key: Schema.String,
            value: Schema.Unknown,
        }),
