...
export class FunctionObject extends S.Class<FunctionObject>("FunctionObject")({
     ...
     */
    strict: S.optionalWith(S.Boolean, {
        nullable: true,
...
export class ResponseFormatJsonSchema extends S.Class<ResponseFormatJsonSchema>(
    ...
    json_schema: S.Struct({
         ...
         */
        name: S.String,
        schema: S.optionalWith(ResponseFormatJsonSchemaSchema, {
            nullable: true,
        }),
        /**
            ...
            code_interpreter: S.optionalWith(
                S.Struct({
                    ...
                    file_ids: S.optionalWith(
                        S.Array(S.String).pipe(S.maxItems(20)),
                        {
                            nullable: true,
                            default: () => [] as const,
                        },
...
export class CreateAssistantRequest extends S.Class<CreateAssistantRequest>(
    ...
    reasoning_effort: S.optionalWith(ReasoningEffort, {
        nullable: true,
...
export class CreateTranscriptionRequest extends S.Class<CreateTranscriptionRequest>(
     ...
     */
    "include[]": S.optionalWith(S.Array(TranscriptionInclude), {
        nullable: true,
    }),
    /**
 ...
 */
export class ServiceTier extends S.Literal(
    "auto",
    "default",
    "flex",
    "scale",
...
export class CreateChatCompletionResponse extends S.Class<CreateChatCompletionResponse>(
     ...
     */
    model: S.String,
    service_tier: S.optionalWith(ServiceTier, {
        nullable: true,
 ...
 */
export class ChatCompletionStreamOptions extends S.Class<ChatCompletionStreamOptions>(
...
export class CreateChatCompletionRequest extends S.Class<CreateChatCompletionRequest>(
    ...
    stream_options: S.optionalWith(S.NullOr(ChatCompletionStreamOptions), {
        default: () => null,
    }),
    /**
...
export class CreateCompletionRequest extends S.Class<CreateCompletionRequest>(
    ...
    prompt: S.NullOr(
        ...
        S.propertySignature,
        S.withConstructorDefault(() => "<|endoftext|>" as const),
    ),
    /**
...
export class CreateCompletionResponse extends S.Class<CreateCompletionResponse>(
    ...
    choices: S.Array(
        S.Struct({
            ...
            logprobs: S.NullOr(
                S.Struct({
                    text_offset: S.optionalWith(S.Array(S.Int), {
                        nullable: true,
                    }),
                    token_logprobs: S.optionalWith(S.Array(S.Number), {
                        nullable: true,
                    }),
                    tokens: S.optionalWith(S.Array(S.String), {
                        nullable: true,
                    }),
                    top_logprobs: S.optionalWith(
 ...
 * in the evaluation.
 */
export class EvalLabelModelGrader extends S.Class<EvalLabelModelGrader>(
 ...
 */
export class EvalStringCheckGraderOperation extends S.Literal(
    "eq",
    "ne",
    "like",
    "ilike",
 ...
 */
export class EvalStringCheckGrader extends S.Class<EvalStringCheckGrader>(
 ...
 * The type of grader.
 */
export class EvalTextSimilarityGraderType extends S.Literal(
    "text_similarity",
) {}
 ...
 */
export class EvalTextSimilarityGrader extends S.Class<EvalTextSimilarityGrader>(
 ...
 */
export class EvalPythonGrader extends S.Class<EvalPythonGrader>(
    "EvalPythonGrader",
)({
    /**
     * The object type, which is always `python`.
 ...
 */
export class EvalScoreModelGrader extends S.Class<EvalScoreModelGrader>(
...
export class GetEvalRunOutputItemsParams extends S.Struct({
    ...
    status: S.optionalWith(GetEvalRunOutputItemsParamsStatus, {
        nullable: true,
    }),
 ...
 */
export class CreateFileRequestPurpose extends S.Literal(
    "assistants",
    "batch",
    "fine-tune",
    "vision",
...
export class FineTuneSupervisedMethodHyperparametersBatchSizeEnum extends S.Literal(
    "auto",
) {}

export class FineTuneSupervisedMethodHyperparametersLearningRateMultiplierEnum extends S.Literal(
    "auto",
) {}

export class FineTuneSupervisedMethodHyperparametersNEpochsEnum extends S.Literal(
    "auto",
) {}
    ...
    hyperparameters: S.optionalWith(
        S.Struct({
            ...
            learning_rate_multiplier: S.optionalWith(
                S.Union(
                    FineTuneSupervisedMethodHyperparametersLearningRateMultiplierEnum,
...
export class FineTuneDPOMethodHyperparametersBetaEnum extends S.Literal(
    "auto",
) {}

export class FineTuneDPOMethodHyperparametersBatchSizeEnum extends S.Literal(
    "auto",
) {}

export class FineTuneDPOMethodHyperparametersLearningRateMultiplierEnum extends S.Literal(
    "auto",
) {}

export class FineTuneDPOMethodHyperparametersNEpochsEnum extends S.Literal(
    "auto",
) {}
...
export class FineTuneDPOMethod extends S.Class<FineTuneDPOMethod>(
    ...
    hyperparameters: S.optionalWith(
        S.Struct({
            ...
            beta: S.optionalWith(
                S.Union(
                    FineTuneDPOMethodHyperparametersBetaEnum,
            ...
            learning_rate_multiplier: S.optionalWith(
                S.Union(
                    FineTuneDPOMethodHyperparametersLearningRateMultiplierEnum,
                    S.Number.pipe(S.greaterThan(0)),
                ),
                {
                    nullable: true,
...
export class FineTuningJobCheckpoint extends S.Class<FineTuningJobCheckpoint>(
    ...
    metrics: S.Struct({
        ...
        full_valid_mean_token_accuracy: S.optionalWith(S.Number, {
            nullable: true,
        }),
    }),
    /**
        ...
        S.Struct({
            ...
            data: S.optionalWith(
                S.Struct({
                     ...
                     */
                    scopes: S.optionalWith(S.Array(S.String), {
                        nullable: true,
                    }),
                }),
                { nullable: true },
                ...
                S.Struct({
                    ...
                    settings: S.optionalWith(
                        S.Struct({
                             ...
                             */
                            threads_ui_visibility: S.optionalWith(S.String, {
                                nullable: true,
                            }),
                            /**
                             * Visibility of the usage dashboard which shows activity and costs for your organization. One of `ANY_ROLE` or `OWNERS`.
                             */
                            usage_dashboard_visibility: S.optionalWith(
                                S.String,
                                { nullable: true },
                            ),
                        }),
        ...
        S.Struct({
            ...
            changes_requested: S.optionalWith(
                S.Struct({
                     ...
                     */
                    max_requests_per_1_minute: S.optionalWith(S.Int, {
                        nullable: true,
                    }),
                    /**
                     * The maximum tokens per minute.
                     */
                    max_tokens_per_1_minute: S.optionalWith(S.Int, {
                        nullable: true,
                    }),
                    /**
                     * The maximum images per minute. Only relevant for certain models.
                     */
                    max_images_per_1_minute: S.optionalWith(S.Int, {
                        nullable: true,
                    }),
                    /**
                     ...
                     */
                    max_requests_per_1_day: S.optionalWith(S.Int, {
                        nullable: true,
                    }),
                    /**
...
export class ToggleCertificatesRequest extends S.Class<ToggleCertificatesRequest>(
    ...
    certificate_ids: S.NonEmptyArray(S.String).pipe(
        S.minItems(1),
        S.maxItems(10),
    ),
}) {}
 ...
 */
export class DeleteCertificateResponseObject extends S.Literal(
    "certificate.deleted",
) {}
...
export class ProjectApiKey extends S.Class<ProjectApiKey>("ProjectApiKey")({
    ...
    owner: S.Struct({
        ...
        service_account: S.optionalWith(ProjectServiceAccount, {
            nullable: true,
        }),
    }),
}) {}
...
export class UsageCodeInterpreterSessionsParams extends S.Struct({
    start_time: S.Int,
    end_time: S.optionalWith(S.Int, { nullable: true }),
    bucket_width: S.optionalWith(
        UsageCodeInterpreterSessionsParamsBucketWidth,
        {
            nullable: true,
            default: () => "1d" as const,
        },
...
export class UsageCompletionsParams extends S.Struct({
    ...
    group_by: S.optionalWith(
        S.Array(
            S.Literal("project_id", "user_id", "api_key_id", "model", "batch"),
        ),
        {
            nullable: true,
        },
 ...
 */
export class RealtimeSessionCreateRequestInputAudioFormat extends S.Literal(
    "pcm16",
    "g711_ulaw",
    "g711_alaw",
) {}
 ...
 */
export class RealtimeSessionCreateRequestOutputAudioFormat extends S.Literal(
    "pcm16",
    "g711_ulaw",
    "g711_alaw",
) {}
 ...
 */
export class RealtimeSessionCreateRequestTurnDetectionType extends S.Literal(
    "server_vad",
    "semantic_vad",
) {}
 ...
 */
export class RealtimeSessionCreateRequestTurnDetectionEagerness extends S.Literal(
    "low",
    "medium",
    "high",
    "auto",
 ...
 */
export class RealtimeSessionCreateRequestInputAudioNoiseReductionType extends S.Literal(
    "near_field",
    "far_field",
) {}
...
export class RealtimeSessionCreateRequest extends S.Class<RealtimeSessionCreateRequest>(
     ...
     * The Realtime model used for this session.
     */
    model: S.optionalWith(RealtimeSessionCreateRequestModel, {
        nullable: true,
    }),
    /**
     ...
     * For `pcm16`, output audio is sampled at a rate of 24kHz.
     */
    output_audio_format: S.optionalWith(
     ...
     * specify a function.
     */
    tool_choice: S.optionalWith(S.String, {
        nullable: true,
        default: () => "auto" as const,
    }),
    /**
...
export class RealtimeSessionCreateResponseMaxResponseOutputTokensEnum extends S.Literal(
    "inf",
) {}
...
export class RealtimeSessionCreateResponse extends S.Class<RealtimeSessionCreateResponse>(
    ...
    max_response_output_tokens: S.optionalWith(
        S.Union(
            S.Int,
            RealtimeSessionCreateResponseMaxResponseOutputTokensEnum,
        ),
        { nullable: true },
    ),
}) {}
 ...
 * The model to use for transcription, current options are `gpt-4o-transcribe`, `gpt-4o-mini-transcribe`, and `whisper-1`.
 */
export class RealtimeTranscriptionSessionCreateRequestInputAudioTranscriptionModel extends S.Literal(
    "gpt-4o-transcribe",
    "gpt-4o-mini-transcribe",
    "whisper-1",
) {}
 ...
 * Used only for `semantic_vad` mode. The eagerness of the model to respond. `low` will wait longer for the user to continue speaking, `high` will respond more quickly. `auto` is the default and is equivalent to `medium`.
 */
export class RealtimeTranscriptionSessionCreateRequestTurnDetectionEagerness extends S.Literal(
    "low",
    "medium",
    "high",
    "auto",
 ...
 * Type of noise reduction. `near_field` is for close-talking microphones such as headphones, `far_field` is for far-field microphones such as laptop or conference room microphones.
 */
export class RealtimeTranscriptionSessionCreateRequestInputAudioNoiseReductionType extends S.Literal(
    "near_field",
    "far_field",
) {}
 ...
 */
export class RealtimeTranscriptionSessionCreateResponseInputAudioTranscriptionModel extends S.Literal(
    "gpt-4o-transcribe",
    "gpt-4o-mini-transcribe",
    "whisper-1",
) {}
 ...
 */
export class VectorStoreFileAttributes extends S.Record({
    key: S.String,
    value: S.Unknown,
}) {}
    ...
    results: S.optionalWith(
        S.Array(
            S.Struct({
                 ...
                 */
                filename: S.optionalWith(S.String, { nullable: true }),
                attributes: S.optionalWith(VectorStoreFileAttributes, {
                    nullable: true,
                }),
                /**
 ...
 */
export class ClickButton extends S.Literal(
    "left",
    "right",
    "wheel",
    "back",
 ...
 */
export class ComputerToolCallSafetyCheck extends S.Class<ComputerToolCallSafetyCheck>(
 ...
 */
export class ComputerCallOutputItemParamStatusEnum extends S.Literal(
    "in_progress",
    "completed",
    "incomplete",
) {}
...
export class ComputerCallOutputItemParam extends S.Class<ComputerCallOutputItemParam>(
    ...
    status: S.optionalWith(ComputerCallOutputItemParamStatusEnum, {
        nullable: true,
    }),
}) {}
 ...
 */
export class FunctionCallOutputItemParamStatusEnum extends S.Literal(
    "in_progress",
    "completed",
    "incomplete",
) {}
...
export class FunctionCallOutputItemParam extends S.Class<FunctionCallOutputItemParam>(
    ...
    status: S.optionalWith(FunctionCallOutputItemParamStatusEnum, {
        nullable: true,
    }),
}) {}
 ...
 */
export class ReasoningSummary extends S.Literal(
    "auto",
    "concise",
    "detailed",
) {}
 ...
 * One of `auto`, `concise`, or `detailed`.
 */
export class ReasoningGenerateSummary extends S.Literal(
    "auto",
    "concise",
    "detailed",
) {}
...
export class Reasoning extends S.Class<Reasoning>("Reasoning")({
    effort: S.optionalWith(ReasoningEffort, {
        nullable: true,
        default: () => "medium" as const,
    }),
    /**
     ...
     * One of `auto`, `concise`, or `detailed`.
     */
    generate_summary: S.optionalWith(ReasoningGenerateSummary, {
        nullable: true,
    }),
}) {}
 ...
 */
export class RankingOptionsRanker extends S.Literal(
    "auto",
    "default-2024-11-15",
) {}
 ...
 */
export class WebSearchPreviewToolSearchContextSize extends S.Literal(
    "low",
    "medium",
    "high",
) {}
...
export class WebSearchPreviewTool extends S.Class<WebSearchPreviewTool>(
     ...
     * High level guidance for the amount of context window space to use for the search. One of `low`, `medium`, or `high`. `medium` is the default.
     */
    search_context_size: S.optionalWith(WebSearchPreviewToolSearchContextSize, {
        nullable: true,
    }),
}) {}
 ...
 */
export class ComputerUsePreviewToolEnvironment extends S.Literal(
    "windows",
    "mac",
    "linux",
    "ubuntu",
...
export class CreateResponse extends S.Class<CreateResponse>("CreateResponse")({
     ...
     */
    parallel_tool_calls: S.optionalWith(S.Boolean, {
        nullable: true,
        default: () => true as const,
    }),
    /**
    ...
    tool_choice: S.optionalWith(
        S.Union(ToolChoiceOptions, ToolChoiceTypes, ToolChoiceFunction),
        { nullable: true },
    ),
    /**
     * The truncation strategy to use for the model response.
     ...
     *   size for a model, the request will fail with a 400 error.
     */
    truncation: S.optionalWith(CreateResponseTruncation, {
        nullable: true,
 ...
 */
export class ResponseIncompleteDetailsReason extends S.Literal(
    "max_output_tokens",
    "content_filter",
) {}
...
export class Response extends S.Class<Response>("Response")({
    ...
    incomplete_details: S.NullOr(
        S.Struct({
             ...
             * The reason why the response is incomplete.
             */
            reason: S.optionalWith(ResponseIncompleteDetailsReason, {
                nullable: true,
            }),
        }),
    ),
     ...
     *   size for a model, the request will fail with a 400 error.
     */
    truncation: S.optionalWith(ResponseTruncation, {
        nullable: true,
        default: () => "disabled" as const,
    }),
    metadata: S.NullOr(Metadata),
...
export class ComputerToolCallOutputResource extends S.Class<ComputerToolCallOutputResource>(
     ...
     */
    acknowledged_safety_checks: S.optionalWith(
        S.Array(ComputerToolCallSafetyCheck),
        { nullable: true },
    ),
    output: ComputerScreenshotImage,
    /**
...
export class CreateThreadAndRunRequest extends S.Class<CreateThreadAndRunRequest>(
     ...
     */
    model: S.optionalWith(
        S.Union(S.String, CreateThreadAndRunRequestModelEnum),
        { nullable: true },
    ),
    /**
 ...
 */
export class RunCompletionUsage extends S.Class<RunCompletionUsage>(
    "RunCompletionUsage",
)({
    /**
 ...
 */
export class MessageObjectIncompleteDetailsReason extends S.Literal(
    "content_filter",
    "max_tokens",
    "run_cancelled",
    "run_expired",
 ...
 */
export class RunStepObjectLastErrorCode extends S.Literal(
    "server_error",
    "rate_limit_exceeded",
) {}
 ...
 */
export class RunStepCompletionUsage extends S.Class<RunStepCompletionUsage>(
 ...
 * One of `server_error` or `rate_limit_exceeded`.
 */
export class VectorStoreFileObjectLastErrorCode extends S.Literal(
    "server_error",
    "unsupported_file",
    "invalid_file",
) {}
...
export class ListVectorStoreFilesParams extends S.Struct({
    ...
    after: S.optionalWith(S.String, { nullable: true }),
    before: S.optionalWith(S.String, { nullable: true }),
    filter: S.optionalWith(ListVectorStoreFilesParamsFilter, {
        nullable: true,
    }),
}) {}
