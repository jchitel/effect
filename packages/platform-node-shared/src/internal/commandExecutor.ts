                    ...
                    (exitCode) =>
                        ...
                        >((resume) => {
                            ...
                            handle.on("error", (err) => {
                                resume(
                                    Effect.fail(
                                        toPlatformError("spawn", err, command),
                                    ),
                                );
                            });
                            handle.on("exit", (...args) => {
                ...
                return pipe(
                    ...
                    Effect.map(
                        ([
                            ...
                            const isRunning = Effect.negate(
                                Deferred.isDone(exitCodeDeferred),
                            );
