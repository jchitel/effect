    ...
    Effect.gen(function* () {
        ...
        const makeConnection = Effect.gen(function* () {
            ...
            const runStatement = (
                ...
                Effect.withFiberRuntime<ReadonlyArray<any>, SqlError>(
                    (fiber) => {
                        if (
                            Context.get(
                        ...
                        try {
                            ...
                            return Effect.succeed(
                                raw
                                    ? (result as unknown as ReadonlyArray<any>)
                                    : [],
                            );
                        } catch (cause) {
                            return Effect.fail(
            ...
            const runValues = (
                ...
                Effect.acquireUseRelease(
                    ...
                    (statement) =>
                        Effect.sync(
                            () => statement.reader && statement.raw(false),
                        ),
                );
            ...
            return identity<SqliteConnection>({
                ...
                executeUnprepared(sql, params, transformRows) {
                    ...
                    return transformRows
                        ? Effect.map(effect, transformRows)
                        : effect;
                },
