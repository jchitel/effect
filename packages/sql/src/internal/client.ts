...
> {
    return Effect.gen(function* () {
        ...
        const withTransaction = makeWithTransaction({
            ...
            begin: (conn) =>
                conn.executeUnprepared(beginTransaction, [], undefined),
            savepoint: (conn, id) =>
...
export const makeWithTransaction =
    <I, S>(options: {
        readonly transactionTag: Context.Tag<
            I,
    ...
    <R, E, A>(
        ...
        Effect.uninterruptibleMask((restore) =>
            Effect.useSpan(
                ...
                (span) =>
                    Effect.withFiberRuntime<A, E | Error.SqlError, R>(
                        (fiber) => {
