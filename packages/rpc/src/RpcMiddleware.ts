 ...
 * @category models
 */
export const SuccessValue: unique symbol = Symbol.for(
    "@effect/rpc/RpcMiddleware/SuccessValue",
);
...
export declare namespace TagClass {
     ...
     * @category models
     */
    export interface Base<Self, Name extends string, Options, Service>
...
export const layerClient = <Id, S, R, EX = never, RX = never>(
    ...
    Layer.scopedContext(
        Effect.gen(function* () {
            ...
            const middleware = Effect.isEffect(service)
                ? yield* service
                : service;
