    ...
    implements ServerRequest.HttpServerRequest
{
    ...
    constructor(
        ...
        private upgradeEffect?: Effect.Effect<
            Socket.Socket,
            Error.RequestError
        >,
        ...
        switch (body._tag) {
            ...
            case "Raw": {
                ...
                if (
                    ...
                    return Effect.tryPromise({
                        try: (signal) =>
                            pipeline(body.body as any, nodeResponse, {
                                signal,
                                end: true,
                            }),
                        catch: (cause) =>
            ...
            case "FormData": {
                return Effect.suspend(() => {
                    ...
                    return Effect.async<void, Error.ResponseError>(
                        (resume, signal) => {
                ...
                return body.stream.pipe(
                    ...
                    Stream.runForEachChunk((chunk) =>
                        Effect.async<void>((resume) => {
                            ...
                            nodeResponse.write(array[array.length - 1], () =>
                                resume(Effect.void),
                            );
                        }),
                    ),
