...
describe("Either", () => {
    ...
    it("try", () => {
        ...
        ).type.toBe<Either.Either<number, Error>>();
    });
    ...
    describe("all", () => {
        ...
        it("struct", () => {
            ...
            >();
            expect(
                Either.all({ a: number$string, b: boolean$string }),
            ).type.toBe<Either.Either<{ a: number; b: boolean }, string>>();
            expect(
                Either.all({ a: number$string, b: boolean$Error }),
            ).type.toBe<
        ...
        it("record", () => {
            const eitherRecord =
                hole<Record<string, Either.Either<number, string>>>();
    ...
    it("andThen", () => {
        ...
        >();
        expect(
            string$string.pipe(Either.andThen(() => number$string)),
    ...
    it("liftPredicate", () => {
        ...
        expect(
            ...
            (a: string | number) => Either.Either<string | number, "b">
        >();
        expect(
    ...
    it("fromNullable", () => {
        ...
        expect(
            Either.fromNullable(nullableString, () => new Error()),
    ...
    it("filterOrLeft", () => {
        ...
        const arrayOfStrings$Error =
            hole<Either.Either<Array<string>, Error>>();
        expect(
            Either.filterOrLeft(
    ...
    it("do notation", () => {
        expect(
            ...
            Either.Either<{ a: number; b: string; c: boolean }, never>
        >();
