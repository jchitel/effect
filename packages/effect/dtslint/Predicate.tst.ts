...
describe("Predicate", () => {
    ...
    it("isBoolean", () => {
        expect(unknowns.filter(Predicate.isBoolean)).type.toBe<
            Array<boolean>
        >();
    });
    ...
    it("isNotNull", () => {
        expect(numberOrNull.filter(Predicate.isNotNull)).type.toBe<
            Array<number>
        >();
    ...
    it("isNullable", () => {
        expect(numberOrNull.filter(Predicate.isNullable)).type.toBe<
            Array<null>
        >();
    ...
    it("tuple", () => {
        ...
        expect(
            Predicate.tuple(
                ...hole<
                    Array<
                        | Predicate.Predicate<number>
                        | Predicate.Refinement<boolean, true>
                    >
                >(),
            ),
        ).type.toBe<
        ...
        expect(
            Predicate.tuple(
                ...hole<Array<Predicate.Refinement<boolean, true>>>(),
            ),
        ).type.toBe<
