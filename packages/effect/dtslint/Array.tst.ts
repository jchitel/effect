...
describe("Array", () => {
    ...
    it("isNonEmptyReadonlyArray", () => {
        if (Array.isNonEmptyReadonlyArray(readonlyNumbers)) {
            expect(readonlyNumbers).type.toBe<
    ...
    it("partition", () => {
        ...
        expect(
            ...
            [
                ...
                satisfying: Array<string | number>,
            ]
        >();
        expect(
    ...
    it("liftPredicate", () => {
        ...
        expect(
            pipe(
                primitiveNumberOrString,
                Array.liftPredicate(Predicate.isString),
            ),
        ).type.toBe<Array<string>>();
        expect(
            pipe(
    ...
    it("zip", () => {
        expect(Array.zip(strings, numbers)).type.toBe<
            Array<[string, number]>
        >();
        expect(pipe(strings, Array.zip(numbers))).type.toBe<
            Array<[string, number]>
        >();
        expect(Array.zip(numbers)(strings)).type.toBe<
            Array<[string, number]>
        >();
    ...
    it("intersperse", () => {
        ...
        expect(pipe(strings, Array.intersperse("a"))).type.toBe<
            Array<string>
        >();
        expect(Array.intersperse("a")(strings)).type.toBe<Array<string>>();

        expect(Array.intersperse(strings, 1)).type.toBe<
            Array<string | number>
        >();
        expect(pipe(strings, Array.intersperse(1))).type.toBe<
            Array<string | number>
        >();
        expect(Array.intersperse(1)(strings)).type.toBe<
            Array<string | number>
        >();
    ...
    it("union", () => {
        expect(Array.union(strings, numbers)).type.toBe<
            Array<string | number>
        >();
        expect(pipe(strings, Array.union(numbers))).type.toBe<
            Array<string | number>
        >();
        expect(Array.union(numbers)(strings)).type.toBe<
            Array<string | number>
        >();
    ...
    it("window", () => {
        ...
        expect(pipe(strings, Array.window(2))).type.toBe<
            Array<Array<string>>
        >();
    ...
    it("unzip", () => {
        ...
        expect(
            pipe(
                hole<Array.NonEmptyReadonlyArray<[string, number]>>(),
                Array.unzip,
            ),
        ).type.toBe<[[string, ...Array<string>], [number, ...Array<number>]]>();
    });
    ...
    it("separate", () => {
        expect(Array.separate([])).type.toBe<
    ...
    it("replaceOption", () => {
        ...
        expect(
            pipe(
                ...
                Array.replaceOption(0, "a" as const),
            ),
        ).type.toBe<Option.Option<Array<"a" | 1 | 2>>>();
    });
