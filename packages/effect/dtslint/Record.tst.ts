...
describe("Record", () => {
    it("NonLiteralKey", () => {
        ...
        expect(
            hole<
                Record.ReadonlyRecord.NonLiteralKey<typeof symA | typeof symB>
            >(),
        ).type.toBe<symbol>();
        expect(
    ...
    it("get", () => {
        expect(Record.get(string$numbers, "a")).type.toBe<
    ...
    it("modifyOption", () => {
        ...
        when(pipe).isCalledWith(
            template$numbers,
            expect(Record.modifyOption).type.not.toBeCallableWith(
                "b",
                () => true,
            ),
        );
    ...
    it("filter", () => {
        ...
        expect(
            pipe(
                ...
                Record.filter(predicateNumbersOrStrings),
            ),
        ).type.toBe<Record<string, string | number>>();
        expect(
    ...
    it("partition", () => {
        expect(
            ...
            [
                ...
                satisfying: Record<string, number>,
            ]
        >();
        expect(
            pipe(
        ...
        expect(
            pipe(
                string$numbersOrStrings,
                Record.partition(predicateNumbersOrStrings),
            ),
        ).type.toBe<
            [
                excluded: Record<string, string | number>,
