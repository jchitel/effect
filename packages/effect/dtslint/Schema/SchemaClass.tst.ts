...
describe("Schema.Class", () => {
    it("should check conflicts with fields/from keys", () => {
        ...
        expect(
            checkForConflicts(
                S.Struct({ from: S.String }).pipe(S.filter(() => true)),
            ),
        ...
        expect(
            ...
            S.Struct<{
                fields: S.filter<S.filter<S.Struct<{ a: typeof S.String }>>>;
            }>
        >();
        expect(
        ...
        expect(
            ...
            S.Struct<{
                from: S.filter<S.filter<S.Struct<{ a: typeof S.String }>>>;
            }>
        >();
    });
    ...
    it("can be extended with Class.extend", () => {
        ...
        expect<S.Schema.Context<typeof Extended>>().type.toBe<
            "a" | "b" | "c"
        >();
    ...
    it("can be extended with another Class `fields` field", () => {
        ...
        expect<
            ConstructorParameters<typeof ExtendedFromClassFields>
        >().type.toBe<
            [
                props: {
                    readonly a: string;
    ...
    it("can be extended with another TaggedClass `fields` field", () => {
        ...
        expect<
            S.Schema.Encoded<typeof ExtendedFromTaggedClassFields>
        >().type.toBe<{
            readonly a: string;
            readonly b: string;
            readonly c: boolean;
        ...
        expect<
            S.Schema.Context<typeof ExtendedFromTaggedClassFields>
        >().type.toBe<"a" | "c">();
