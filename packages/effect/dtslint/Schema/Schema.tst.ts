...
describe("Schema", () => {
    ...
    describe("Type Level Helpers", () => {
        it("Schema.Encoded", () => {
            ...
            expect<
                S.Schema.Encoded<typeof S.NumberFromString>
            >().type.toBe<string>();
        });
        ...
        it("Schema.Type", () => {
            ...
            expect<
                S.Schema.Type<typeof S.NumberFromString>
            >().type.toBe<number>();
        });
        ...
        it("Struct.Type", () => {
            ...
            expect(
                hole<
                    Types.Simplify<
                        S.Struct.Type<{ a: S.Schema<number, string> }>
                    >
                >(),
        ...
        it("Struct.Encoded", () => {
            expect(
                hole<Types.Simplify<S.Struct.Encoded<{}>>>(),
            ).type.toBe<{}>();
            expect(
                hole<
                    Types.Simplify<
                        S.Struct.Encoded<{ a: S.Schema<number, string> }>
                    >
                >(),
        ...
        it("TupleType.Encoded", () => {
            expect(hole<S.TupleType.Encoded<[], []>>()).type.toBe<
                readonly []
            >();
            expect(
            ...
            expect(
                hole<
                    S.Schema.Context<
                        S.TupleType<
                            [typeof aContext],
                            [typeof bContext, typeof cContext]
                        >
                    >
                >(),
            ).type.toBe<"a" | "b" | "c">();
    ...
    it("annotations", () => {
        ...
        interface AnnotatedString
            extends S.Annotable<AnnotatedString, string> {}
        ...
        ).type.toBe<S.Struct<{ a: AnnotatedString }>>();
    ...
    it("Primitives", () => {
        ...
        expect(S.asSchema(S.Undefined)).type.toBe<
            S.Schema<undefined, undefined>
        >();
        ...
        expect(S.asSchema(S.BigIntFromSelf)).type.toBe<
        ...
        expect(S.asSchema(S.SymbolFromSelf)).type.toBe<
            S.Schema<symbol, symbol>
        >();
    ...
    it("Literal", () => {
        ...
        expect(S.Literal(...([] as Array<"a" | "b">))).type.toBe<
            S.SchemaClass<"a" | "b">
        >();
        expect(S.Literal(...([] as Array<never>))).type.toBe<
            S.SchemaClass<never>
        >();
        ...
        expect(S.asSchema(S.Literal("a", "b", "c"))).type.toBe<
            S.Schema<"a" | "b" | "c">
        >();
        expect(S.Literal("a", "b", "c")).type.toBe<
            S.Literal<["a", "b", "c"]>
        >();
    ...
    describe("Enums", () => {
        ...
        it("Schema Type", () => {
            expect(S.asSchema(schema)).type.toBeAssignableTo<
                S.Schema<Fruits>
            >();
    ...
    it("UndefinedOr", () => {
        expect(S.UndefinedOr(S.Never)).type.toBe<
            S.UndefinedOr<typeof S.Never>
        >();
    });
    ...
    describe("Union", () => {
        it("should allow Never members", () => {
            ...
            expect(schema).type.toBe<
                S.Union<[typeof S.String, typeof S.Never]>
            >();
        });
    ...
    it("keyof", () => {
        ...
        ).type.toBe<S.SchemaClass<"a" | "b", "a" | "b">>();
    });
    ...
    describe("Tuple", () => {
        ...
        it("Array", () => {
            ...
            expect(pipe(S.Number, S.Array)).type.toBe<
                S.Array$<typeof S.Number>
            >();
            ...
            expect(S.Array(S.String).rest).type.toBe<
                readonly [typeof S.String]
            >();
        });
    });
    ...
    describe("Struct", () => {
        ...
        it("pick", () => {
            expect(S.Struct({ a: S.String }).pick).type.not.toBeCallableWith(
                "c",
            );
            expect(
                S.Struct({
            ...
            expect(
                S.Struct({ a: S.String, b: S.Number, c: S.Boolean }).pick(
                    "a",
                    "b",
                ),
        ...
        it("omit", () => {
            expect(S.Struct({ a: S.String }).omit).type.not.toBeCallableWith(
                "c",
            );
            expect(
                S.Struct({
            ...
            >(
                ...
                expect(omitted).type.toBe<
                    S.Struct<{
                        [K in keyof Omit<Fields, "a">]: Omit<Fields, "a">[K];
                    }>
                >();
    ...
    describe("Record", () => {
        ...
        it("keys as branded types (string)", () => {
            ...
            expect(schema).type.toBe<
                S.Record$<
                    S.brand<typeof S.String, "UserId">,
                    typeof S.NumberFromString
                >
            >();
            expect(
        ...
        it("keys as branded types (symbol)", () => {
            ...
            expect(schema).type.toBe<
                S.Record$<
                    S.brand<typeof S.String, symbol>,
                    typeof S.NumberFromString
                >
            >();
            expect(
    ...
    describe("optionalWith", () => {
        it("{ exact: true }", () => {
            ...
            expect(
                ...
                S.Struct<{
                    a: S.optionalWith<S.Literal<["a", "b"]>, { exact: true }>;
                }>
            >();
        });
        ...
        it("{ exact: true, as: 'Option' }", () => {
            ...
            expect(
                S.asSchema(
                    S.Struct({
                        a: S.String.pipe(
                            S.optionalWith({ exact: true, as: "Option" }),
                        ),
                    }),
                ),
            ).type.toBe<
        ...
        it("{ as: 'Option' }", () => {
            ...
            expect(
                S.asSchema(
                    S.Struct({
                        a: S.String.pipe(S.optionalWith({ as: "Option" })),
                    }),
                ),
            ).type.toBe<
                S.Schema<
    ...
    it("partialWith", () => {
        expect(
            S.partialWith(S.Struct({ a: S.String, b: S.Number }), {
                exact: true,
            }),
        ).type.toBe<
            S.SchemaClass<
    ...
    it("extend", () => {
        ...
        expect(
            ...
            S.extend<
                ...
                S.Union<
                    [
                        S.Struct<{ b: typeof S.Number }>,
                        S.Struct<{ c: typeof S.Boolean }>,
                    ]
                >
            >
        >();
    ...
    it("suspend", () => {
        ...
        const SuspendIEqualA = S.Struct({
            a: S.Number,
            as: S.Array(
                S.suspend((): S.Schema<SuspendIEqualA> => SuspendIEqualA),
            ),
        });
        expect(SuspendIEqualA.fields).type.toBe<{
            readonly a: typeof S.Number;
            readonly as: S.Array$<
                S.suspend<SuspendIEqualA, SuspendIEqualA, never>
            >;
        }>();
    ...
    it("TemplateLiteral", () => {
        ...
        expect(S.TemplateLiteral(S.Literal(1))).type.toBe<
            S.TemplateLiteral<"1">
        >();
        expect(S.TemplateLiteral(S.String)).type.toBe<
            S.TemplateLiteral<string>
        >();
        expect(S.TemplateLiteral(S.Number)).type.toBe<
            S.TemplateLiteral<`${number}`>
        >();
        expect(S.TemplateLiteral("a", "b")).type.toBe<
    ...
    describe("compose", () => {
        it("{ strict: true } should not allow incompatible types", () => {
            ...
            when(S.String.pipe).isCalledWith(
                expect(S.compose).type.not.toBeCallableWith(S.Number, {
                    strict: true,
                }),
            );
        });
        ...
        it("data last", () => {
            ...
            expect(S.asSchema(schema1_2)).type.toBe<
                S.Schema<number, string | null>
            >();
            ...
            // fourth overload
            const schema4 = S.String.pipe(
                S.compose(S.Number, { strict: false }),
            );
            expect(S.asSchema(schema4)).type.toBe<S.Schema<number, string>>();
            expect(schema4).type.toBe<
        ...
        it("data first", () => {
            ...
            // second overload
            const schema2 = S.compose(
                S.NumberFromString,
                S.Union(S.Null, S.Number),
            );
            expect(schema2).type.toBe<
                S.transform<
                    typeof S.NumberFromString,
    ...
    it("mutable", () => {
        ...
        expect(
            ...
            S.Schema<{ [x: string]: number }, { [x: string]: number }>
        >();
    ...
    it("transformOrFail", () => {
        ...
        expect(S.asSchema(transformOrFail1)).type.toBe<
    ...
    it("withConstructorDefault", () => {
        ...
        expect(
            S.propertySignature(S.String).pipe(
                S.withConstructorDefault(() => "a"),
            ),
        ).type.toBe<
            S.PropertySignature<":", string, never, ":", string, true>
        >();
        expect(
    ...
    it("TemplateLiteralParser", () => {
        ...
        expect(
            S.asSchema(
                S.TemplateLiteralParser(S.String, S.Literal("/"), S.Number),
            ),
        ).type.toBe<
        ...
        expect(
            S.asSchema(
                S.TemplateLiteralParser(S.String.pipe(S.brand("MyBrand"))),
            ),
        ).type.toBe<
            S.Schema<readonly [string & Brand.Brand<"MyBrand">], string>
        >();
        expect(
            S.asSchema(
                S.TemplateLiteralParser(S.Number.pipe(S.brand("MyBrand"))),
            ),
        ).type.toBe<
        ...
        expect(
            S.asSchema(
                S.TemplateLiteralParser("a", S.Union(S.Number, S.String)),
            ),
        ).type.toBe<
            S.Schema<
    ...
    describe("Filters", () => {
        it("filter", () => {
            ...
            const predicateFilter1 = (u: unknown): boolean =>
                typeof u === "string";
            ...
            expect(
                pipe(
                    S.Number,
                    S.filter(
                        (n): n is number & Brand.Brand<"MyNumber"> => n > 0,
                    ),
                ),
            ).type.toBe<
                ...
                S.filter(
                    ...
                    },
                    {
                        arbitrary: (from, ctx) => (fc) => {
                            expect(from).type.toBe<
                                Arbitrary.LazyArbitrary<string>
                            >();
                            expect(
                                ctx,
                            ).type.toBe<Arbitrary.ArbitraryGenerationContext>();
                            return fc.string();
                        },
                        pretty: (from) => (s) => {
        ...
        describe("BigInt Filters", () => {
            ...
            it("greaterThanOrEqualToBigInt", () => {
                when(pipe).isCalledWith(
                    S.Null,
                    expect(
                        S.greaterThanOrEqualToBigInt,
                    ).type.not.toBeCallableWith(5n),
                );

                const schema = pipe(
                    S.BigIntFromSelf,
                    S.greaterThanOrEqualToBigInt(5n),
                );
                expect(S.asSchema(schema)).type.toBe<S.Schema<bigint>>();
                expect(schema).type.toBe<S.filter<typeof S.BigIntFromSelf>>();
                expect(schema.annotations({})).type.toBe<
            ...
            it("lessThanOrEqualToBigInt", () => {
                when(pipe).isCalledWith(
                    S.Null,
                    expect(S.lessThanOrEqualToBigInt).type.not.toBeCallableWith(
                        5n,
                    ),
                );
        ...
        describe("Duration filters", () => {
            it("lessThanDuration", () => {
                when(pipe).isCalledWith(
                    S.Null,
                    expect(S.lessThanDuration).type.not.toBeCallableWith(
                        "10 millis",
                    ),
                );
            ...
            it("lessThanOrEqualToDuration", () => {
                when(pipe).isCalledWith(
                    S.Null,
                    expect(
                        S.lessThanOrEqualToDuration,
                    ).type.not.toBeCallableWith("10 millis"),
                );
            ...
            it("greaterThanDuration", () => {
                when(pipe).isCalledWith(
                    S.Null,
                    expect(S.greaterThanDuration).type.not.toBeCallableWith(
                        "10 millis",
                    ),
                );
            ...
            it("greaterThanOrEqualToDuration", () => {
                when(pipe).isCalledWith(
                    S.Null,
                    expect(
                        S.greaterThanOrEqualToDuration,
                    ).type.not.toBeCallableWith("10 millis"),
                );
        ...
        describe("Array Filters", () => {
            ...
            describe("NonEmptyArray", () => {
                it("minItems", () => {
                    const schema = S.NonEmptyArray(S.String).pipe(
                        S.minItems(2),
                    );
                    expect(S.asSchema(schema)).type.toBe<
                    ...
                    expect(schema.from).type.toBe<
                        S.NonEmptyArray<typeof S.String>
                    >();
                });
        ...
        describe("Date Filters", () => {
            ...
            it("lessThanDate", () => {
                when(pipe).isCalledWith(
                    S.Null,
                    expect(S.lessThanDate).type.not.toBeCallableWith(
                        new Date(),
                    ),
                );
            ...
            it("lessThanOrEqualToDate", () => {
                when(pipe).isCalledWith(
                    S.Null,
                    expect(S.lessThanOrEqualToDate).type.not.toBeCallableWith(
                        new Date(),
                    ),
                );
                ...
                const schema = pipe(
                    S.DateFromSelf,
                    S.lessThanOrEqualToDate(new Date()),
                );
                expect(S.asSchema(schema)).type.toBe<S.Schema<Date>>();
                expect(schema).type.toBe<S.filter<typeof S.DateFromSelf>>();
                expect(schema.annotations({})).type.toBe<
            ...
            it("greaterThanDate", () => {
                when(pipe).isCalledWith(
                    S.Null,
                    expect(S.greaterThanDate).type.not.toBeCallableWith(
                        new Date(),
                    ),
                );
            ...
            it("greaterThanOrEqualToDate", () => {
                when(pipe).isCalledWith(
                    S.Null,
                    expect(
                        S.greaterThanOrEqualToDate,
                    ).type.not.toBeCallableWith(new Date()),
                );
        ...
        describe("BigDecimal Filters", () => {
            ...
            it("greaterThanBigDecimal", () => {
                when(pipe).isCalledWith(
                    S.Null,
                    expect(S.greaterThanBigDecimal).type.not.toBeCallableWith(
                        bd,
                    ),
                );
                ...
                const schema = pipe(
                    ...
                    S.greaterThanBigDecimal(bd),
                );
                expect(S.asSchema(schema)).type.toBe<
                    S.Schema<BigDecimal.BigDecimal>
                >();
                expect(schema).type.toBe<
            ...
            it("greaterThanOrEqualToBigDecimal", () => {
                when(pipe).isCalledWith(
                    S.Null,
                    expect(
                        S.greaterThanOrEqualToBigDecimal,
                    ).type.not.toBeCallableWith(bd),
                );
            ...
            it("betweenBigDecimal", () => {
                when(pipe).isCalledWith(
                    S.Null,
                    expect(S.betweenBigDecimal).type.not.toBeCallableWith(
                        bd,
                        bd,
                    ),
                );
    ...
    describe("Data Types", () => {
        ...
        it("TimeZoneOffsetFromSelf", () => {
            ...
            expect(S.asSchema(schema)).type.toBe<
                S.Schema<DateTime.TimeZone.Offset>
            >();
        ...
        it("TimeZoneNamedFromSelf", () => {
            ...
            expect(S.asSchema(schema)).type.toBe<
                S.Schema<DateTime.TimeZone.Named>
            >();
        ...
        it("Chunk", () => {
            ...
            expect(schema.to).type.toBe<
                S.ChunkFromSelf<S.SchemaClass<number>>
            >();
        });
        ...
        it("Data", () => {
            ...
            expect(S.Data).type.not.toBeCallableWith(
                hole<S.Schema<{}, number>>(),
            );
        ...
        it("Redacted", () => {
            ...
            expect(schema.to).type.toBe<
                S.RedactedFromSelf<S.SchemaClass<number>>
            >();
        });
        ...
        it("OptionFromUndefinedOr", () => {
            ...
            >();
            expect(schema.from).type.toBe<
                S.UndefinedOr<typeof S.NumberFromString>
            >();
            expect(schema.to).type.toBe<
                S.OptionFromSelf<S.SchemaClass<number>>
            >();
        ...
        it("OptionFromNullishOr", () => {
            ...
            >();
            expect(schema.from).type.toBe<
                S.NullishOr<typeof S.NumberFromString>
            >();
            expect(schema.to).type.toBe<
                S.OptionFromSelf<S.SchemaClass<number>>
            >();
        ...
        it("HashSet", () => {
            ...
            >();
            expect(schema.to).type.toBe<
                S.HashSetFromSelf<S.SchemaClass<number>>
            >();
        });
        ...
        it("List", () => {
            ...
            >();
            expect(schema.to).type.toBe<
                S.ListFromSelf<S.SchemaClass<number>>
            >();
        });
        ...
        it("SortedSetFromSelf", () => {
            const schema = S.SortedSetFromSelf(
                S.NumberFromString,
                N.Order,
                Str.Order,
            );
        ...
        it("SortedSet", () => {
            ...
            >();
            expect(schema.to).type.toBe<
                S.SortedSetFromSelf<S.SchemaClass<number>>
            >();
        });
    ...
    it("ArrayEnsure", () => {
        ...
        expect(schema.from).type.toBe<
            S.Union<
                [typeof S.NumberFromString, S.Array$<typeof S.NumberFromString>]
            >
        >();
    ...
    describe("Transformations", () => {
        ...
        it("headNonEmpty", () => {
            ...
            expect(schema).type.toBe<
                S.transform<
                    S.NonEmptyArray<typeof S.Number>,
                    S.SchemaClass<number>
                >
            >();
            expect(schema.annotations({})).type.toBe<
        ...
        it("pluck", () => {
            ...
            expect(
                S.pluck(
                    S.Struct({ a: S.optional(S.String), b: S.Number }),
                    "a",
                ),
            ).type.toBe<
                S.SchemaClass<
            ...
            expect(
                ...
                S.SchemaClass<string | undefined, { readonly a?: string }>
            >();
            expect(
                pipe(
                    S.Struct({
    ...
    it("standardSchemaV1", () => {
        ...
        expect(S.asSchema(standardSchema)).type.toBe<
            S.Schema<number, string>
        >();
        expect(standardSchema).type.toBe<
            StandardSchemaV1<string, number> &
                S.SchemaClass<number, string, never>
        >();
    });
});
