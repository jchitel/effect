...
describe("Schema Context", () => {
    ...
    it("NonEmptyArray", () => {
        expect(S.asSchema(S.NonEmptyArray(aContext))).type.toBe<
            ...
            >
        >();
        expect(S.NonEmptyArray(aContext)).type.toBe<
    ...
    it("partialWith", () => {
        expect(
            S.partialWith(S.Struct({ a: aContext, b: bContext }), {
                exact: true,
            }),
        ).type.toBe<
            S.SchemaClass<
    ...
    it("filter", () => {
        expect(aContext.pipe(S.filter(() => false))).type.toBe<
            S.filter<aContext>
        >();
    });
    ...
    it("rename", () => {
        expect(
            S.rename(S.Struct({ a: aContext, b: bContext }), {
                a: "c",
                b: "d",
            }),
        ).type.toBe<
