...
describe("Stream", () => {
    ...
    it("partition", () => {
        ...
        expect(
            ...
            Effect.Effect<
                [
                    excluded: Stream.Stream<string>,
                    satisfying: Stream.Stream<number>,
                ],
                never,
                Scope.Scope
            >
    ...
    it("split", () => {
        ...
        ).type.toBe<Stream.Stream<Chunk.Chunk<number>, never, never>>();
        ...
        ).type.toBe<Stream.Stream<Chunk.Chunk<string>, never, never>>();
    });
