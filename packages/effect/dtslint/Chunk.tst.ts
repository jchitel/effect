...
describe("Chunk", () => {
    ...
    it("prependAll", () => {
        ...
        ).type.toBe<Chunk.NonEmptyChunk<string | number>>();
    });
    ...
    it("flatten", () => {
        ...
        expect(
            pipe(
                hole<Chunk.Chunk<Chunk.NonEmptyChunk<number>>>(),
                Chunk.flatten,
            ),
        ).type.toBe<Chunk.Chunk<number>>();
        ...
        expect(
            pipe(
                hole<Chunk.NonEmptyChunk<Chunk.Chunk<number>>>(),
                Chunk.flatten,
            ),
        ).type.toBe<Chunk.Chunk<number>>();
        ...
        const nestedChunk =
            hole<
                Effect.Effect<Chunk.Chunk<Chunk.Chunk<number>>, never, never>
            >();
