...
describe("Option", () => {
    it("liftPredicate", () => {
        ...
        expect(
            Option.liftPredicate(primitiveNumerOrString, (n): n is number => {
        ...
        expect(
            pipe(
                primitiveNumber,
                Option.liftPredicate(predicateNumbersOrStrings),
            ),
        ).type.toBe<Option.Option<number>>();
    });
    ...
    describe("all", () => {
        it("tuple", () => {
            ...
            expect(Option.all([Option.some(1)])).type.toBe<
                Option.Option<[number]>
            >();
        ...
        it("array", () => {
            ...
            expect(Option.all(optionArray)).type.toBe<
