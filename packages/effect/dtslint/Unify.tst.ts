...
describe("Unify", () => {
    describe("Unify", () => {
        ...
        it("should unify Either types", () => {
            expect<
                Unify.Unify<
                    Either.Either<"RA", "LA"> | Either.Either<"RB", "LB">
                >
        ...
        it("should unify Exit types", () => {
            expect<
                Unify.Unify<Exit.Exit<0, 1> | Exit.Exit<"a", "b">>
        ...
        it("should unify Deferred types", () => {
            expect<
                Unify.Unify<
                    Deferred.Deferred<1, 2> | Deferred.Deferred<"a", "b">
                >
            >().type.toBe<
                Deferred.Deferred<1, 2> | Deferred.Deferred<"a", "b">
            >();
        ...
        it("should unify RuntimeFiber types", () => {
            expect<
                Unify.Unify<
                    Fiber.RuntimeFiber<1, 2> | Fiber.RuntimeFiber<"a", "b">
                >
        ...
        it("should unify Dequeue types", () => {
            expect<
                Unify.Unify<Queue.Dequeue<1> | Queue.Dequeue<"a">>
        ...
        it("should unify Pool types", () => {
            expect<
                Unify.Unify<
                    Pool.Pool<1, 2> | Pool.Pool<"a", "b"> | Pool.Pool<"a", "c">
                >
    ...
    describe("unify", () => {
        ...
        it("should unify a value using Unify.unify", () => {
            expect(
                Unify.unify(
                    Math.random() > 0 ? Either.right(10) : Either.left("ok"),
                ),
