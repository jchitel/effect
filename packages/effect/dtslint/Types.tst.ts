...
describe("Types", () => {
    it("TupleOf", () => {
        expect<Types.TupleOf<3, number>>().type.toBe<
    ...
    it("ExcludeTag", () => {
        expect<
            Types.ExcludeTag<string | { _tag: "a" } | { _tag: "b" }, "a"> &
                unknown
    ...
    it("Simplify", () => {
        expect<
            Types.Simplify<object & { a: number } & { b: number }>
    ...
    describe("Equals", () => {
        it("should return true for identical types", () => {
            expect<
                Types.Equals<{ a: number }, { a: number }>
            >().type.toBe<true>();
        });
        it("should return false for different types", () => {
            expect<
                Types.Equals<{ a: number }, { b: number }>
            >().type.toBe<false>();
        });
    });
    ...
    describe("Mutable", () => {
        ...
        it("should convert a ReadonlyArray to a mutable array", () => {
            expect<Types.Mutable<ReadonlyArray<string>>>().type.toBe<
                Array<string>
            >();
        });
    ...
    describe("DeepMutable", () => {
        ...
        describe("Struct", () => {
            ...
            it("should deeply mutate nested structs", () => {
                expect<
                    Types.DeepMutable<
                        ReadonlyArray<
                            TaggedValues<TaggedValues<TaggedValues<boolean>>>
                        >
                    >
                >().type.toBe<
                    Array<{
        ...
        describe("Array", () => {
            ...
            it("should leave a mutable array unchanged", () => {
                expect<Types.DeepMutable<Array<string>>>().type.toBe<
                    Array<string>
                >();
            });
        });
        ...
        describe("Tuple", () => {
            ...
            it("should leave a mutable tuple unchanged", () => {
                expect<
                    Types.DeepMutable<[string, number, boolean]>
                >().type.toBe<[string, number, boolean]>();
            });
        });
        ...
        describe("ReadonlySet", () => {
            ...
            it("should leave a mutable Set unchanged", () => {
                expect<
                    Types.DeepMutable<
                        Set<{ readonly value: TaggedValues<number> }>
                    >
                >().type.toBe<
                    Set<{ value: { _tag: string; value: Array<number> } }>
                >();
    ...
    describe("MatchRecord", () => {
        it("should yield 1 when matching a record type", () => {
            expect<
                Types.MatchRecord<{ [x: string]: number }, 1, 0>
            >().type.toBe<1>();
        });
