            ...
            fc.asyncProperty(
                ...
                async (n, as) => {
                    ...
                    deepStrictEqual(
                        ...
                        as.slice(
                            0,
                            Array.from(result1).filter((n) => n > 0).length,
                        ),
                    );
                    deepStrictEqual(
                        Array.from(result1).filter((n) => n < 0),
                    ...
                    deepStrictEqual(
                        ...
                        as.slice(
                            0,
                            Array.from(result2).filter((n) => n > 0).length,
                        ),
                    );
                    deepStrictEqual(
                        Array.from(result2).filter((n) => n < 0),
        ...
        fc.assert(
            fc.asyncProperty(
                ...
                async (n, as) => {
                    ...
                    deepStrictEqual(
                        Array.from(result1),
                        sort(Array.from(result1)),
                    );
                    deepStrictEqual(
                        Array.from(result2),
                        sort(Array.from(result2)),
                    );
                },
            ),
        ));
