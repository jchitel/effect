...
describe("List", () => {
    it("is an iterable", () => {
        deepStrictEqual(
            Array.fromIterable(List.make(0, 1, 2, 3)),
            [0, 1, 2, 3],
        );
    });
    ...
    it("reduceRight", () => {
        ...
        deepStrictEqual(
            List.reduceRight(List.make("a", "b", "c"), "", f),
            "cba",
        );
    });
    ...
    it("take", () => {
        ...
        deepStrictEqual(
            List.take(List.make(1, 2, 3, 4), 10),
            List.make(1, 2, 3, 4),
        );
    });
    ...
    it("unsafeTail", () => {
        ...
        deepStrictEqual(
            List.unsafeTail(List.make(1, 2, 3, 4)),
            List.make(2, 3, 4),
        );
    });
  ...
  "values": [
    ...
    it("compact", () => {
        ...
        deepStrictEqual(
            List.compact(
                List.make(Option.some(1), Option.some(2), Option.some(3)),
            ),
            List.make(1, 2, 3),
        );
        deepStrictEqual(
            List.compact(
                List.make(Option.some(1), Option.none(), Option.some(3)),
            ),
            List.make(1, 3),
        );
    });
    ...
    it("filter", () => {
        ...
        deepStrictEqual(
            List.filter(List.make(2, 4, 1), isEven),
            List.make(2, 4),
        );
        deepStrictEqual(
            List.filter(List.make(2, 4, 1, 3), isEven),
            List.make(2, 4),
        );
        deepStrictEqual(
        ...
        const r5 = List.filter(
            List.appendAll(List.make(2, 4, 1), share3),
            isEven,
        );
