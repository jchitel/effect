...
describe("Record", () => {
    describe("string | symbol APIs", () => {
        ...
        it("replaceOption", () => {
            assertNone(
                pipe(Record.empty<string>(), Record.replaceOption("a", 2)),
            );
            ...
            assertNone(
                pipe(Record.empty<symbol>(), Record.replaceOption(symA, 2)),
            );
        ...
        it("replace", () => {
            ...
            deepStrictEqual(
                Record.replace(symbolRecord, symC, 3),
                symbolRecord,
            );
    ...
    describe("string only APIs", () => {
        ...
        it("partitionMap", () => {
            ...
            deepStrictEqual(
                Record.partitionMap({ a: 1, b: 3, [symA]: null }, f),
                [{ a: 0 }, { b: 4 }],
            );
        });
        ...
        it("isEmptyReadonlyRecord", () => {
            ...
            deepStrictEqual(
                Record.isEmptyReadonlyRecord({ [symA]: null }),
                true,
            );
        ...
        it("size", () => {
            deepStrictEqual(
                Record.size({ a: "a", b: 1, c: true, [symA]: null }),
                3,
            );
        });

        it("keys", () => {
            deepStrictEqual(Record.keys({ a: 1, b: 2, [symA]: null }), [
                "a",
                "b",
            ]);
        });
        ...
        it("values", () => {
            deepStrictEqual(
                Record.values({ a: 1, b: 2, [symA]: null }),
                [1, 2],
            );
        });
        ...
        it("isSubrecord", () => {
            ...
            assertTrue(
                Record.isSubrecord({ a: 1 } as Record<string, number>, {
                    a: 1,
                    b: 2,
                }),
            );
            ...
            assertFalse(
                Record.isSubrecord({ b: 2 } as Record<string, number>, {
                    a: 1,
                }),
            );
        });
