...
describe("Duration", () => {
    ...
    it("decodeUnknown", () => {
        ...
        assertSome(
            Duration.decodeUnknown("1.5 seconds"),
    ...
    it("Order", () => {
        deepStrictEqual(
            Duration.Order(Duration.millis(1), Duration.millis(2)),
            -1,
        );
        deepStrictEqual(
            Duration.Order(Duration.millis(2), Duration.millis(1)),
            1,
        );
        deepStrictEqual(
            Duration.Order(Duration.millis(2), Duration.millis(2)),
            0,
        );

        deepStrictEqual(
            Duration.Order(Duration.nanos(1n), Duration.nanos(2n)),
            -1,
        );
        deepStrictEqual(
            Duration.Order(Duration.nanos(2n), Duration.nanos(1n)),
            1,
        );
        deepStrictEqual(
            Duration.Order(Duration.nanos(2n), Duration.nanos(2n)),
            0,
        );
    });
    ...
    it("equals", () => {
        assertTrue(
            pipe(Duration.hours(1), Duration.equals(Duration.minutes(60))),
        );
    ...
    it("divide", () => {
        ...
        assertNone(Duration.divide(Duration.nanos(1n), -0));
        assertSome(
            Duration.divide(Duration.minutes(1), 0.5),
            Duration.minutes(2),
        );
        assertSome(
            Duration.divide(Duration.minutes(1), 1.5),
            Duration.seconds(40),
        );
    ...
    it("unsafeDivide", () => {
        ...
        deepStrictEqual(
            Duration.unsafeDivide(Duration.nanos(1n), 3),
            Duration.zero,
        );
        deepStrictEqual(
        ...
        deepStrictEqual(
            Duration.unsafeDivide("1 minute", 2),
            Duration.seconds(30),
        );
    });
    ...
    it("greaterThan", () => {
        assertTrue(
            pipe(
                Duration.seconds(30),
                Duration.greaterThan(Duration.seconds(20)),
            ),
        );
        assertFalse(
            pipe(
                Duration.seconds(30),
                Duration.greaterThan(Duration.seconds(30)),
            ),
        );
        assertFalse(
            pipe(
                Duration.seconds(30),
                Duration.greaterThan(Duration.seconds(60)),
            ),
        );
        ...
        assertTrue(
            pipe(
                Duration.nanos(30n),
                Duration.greaterThan(Duration.nanos(20n)),
            ),
        );
        assertFalse(
            pipe(
                Duration.nanos(30n),
                Duration.greaterThan(Duration.nanos(30n)),
            ),
        );
        assertFalse(
            pipe(
                Duration.nanos(30n),
                Duration.greaterThan(Duration.nanos(60n)),
            ),
        );
    ...
    it("greaterThan - Infinity", () => {
        ...
        assertFalse(
            pipe(
                Duration.seconds(-Infinity),
                Duration.greaterThan(Duration.infinity),
            ),
        );
        assertFalse(
    ...
    it("lessThan", () => {
        ...
        assertTrue(
            pipe(Duration.nanos(1n), Duration.lessThan(Duration.millis(1))),
        );
    ...
    it("lessThanOrEqualTo", () => {
        ...
        assertTrue(
            pipe(
                Duration.nanos(20n),
                Duration.lessThanOrEqualTo(Duration.nanos(30n)),
            ),
        );
        assertTrue(
            pipe(
    ...
    it("format", () => {
        ...
        strictEqual(
            Duration.format(Duration.hours(3.11125)),
            `3h 6m 40s 500ms`,
        );
    ...
    it("unsafeToNanos", () => {
        ...
        strictEqual(
            Duration.millis(100).pipe(Duration.unsafeToNanos),
            100_000_000n,
        );
    ...
    it("toHrTime", () => {
        deepStrictEqual(
            Duration.millis(1).pipe(Duration.toHrTime),
            [0, 1_000_000],
        );
        ...
        deepStrictEqual(Duration.infinity.pipe(Duration.toHrTime), [
            Infinity,
            0,
        ]);
    ...
    it("toHours", () => {
        ...
        strictEqual(
            Duration.nanos(3_600_000_000_000n).pipe(Duration.toHours),
            1,
        );
    ...
    it("toDays", () => {
        ...
        strictEqual(
            Duration.nanos(86_400_000_000_000n).pipe(Duration.toDays),
            1,
        );
