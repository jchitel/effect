...
describe("BigInt", () => {
    ...
    it("between", () => {
        deepStrictEqual(
            BigInt_.between({ minimum: 0n, maximum: 5n })(3n),
            true,
        );
        deepStrictEqual(
            BigInt_.between({ minimum: 0n, maximum: 5n })(-1n),
            false,
        );
        deepStrictEqual(
            BigInt_.between({ minimum: 0n, maximum: 5n })(6n),
            false,
        );

        deepStrictEqual(
            BigInt_.between(3n, { minimum: 0n, maximum: 5n }),
            true,
        );
    });
    ...
    it("toNumber", () => {
        ...
        assertNone(
            BigInt_.toNumber(BigInt(Number.MAX_SAFE_INTEGER) + BigInt(1)),
        );
        assertSome(
        ...
        assertNone(
            BigInt_.toNumber(BigInt(Number.MIN_SAFE_INTEGER) - BigInt(1)),
        );
