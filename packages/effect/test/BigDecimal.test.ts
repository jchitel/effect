...
describe("BigDecimal", () => {
    ...
    it("between", () => {
        ...
        assertFalse(
            BigDecimal.between({ minimum: $("0.02"), maximum: $("5") })(
                $("0.0123"),
            ),
        );
        assertTrue(
    ...
    it("clamp", () => {
        ...
        assertEquals(
            BigDecimal.clamp({ minimum: $("0.02"), maximum: $("5") })(
                $("0.0123"),
            ),
            $("0.02"),
        );
    ...
    it("remainder", () => {
        ...
        assertEquals(
            BigDecimal.remainder($("123.456"), $("0.2")).pipe(
                Option.getOrThrow,
            ),
            $("0.056"),
        );
    ...
    it("unsafeRemainder", () => {
        ...
        assertEquals(
            BigDecimal.unsafeRemainder($("123.456"), $("0.2")),
            $("0.056"),
        );
        throws(
    ...
    it("format", () => {
        ...
        strictEqual(
            BigDecimal.format(BigDecimal.make(12345n, -25)),
            "1.2345e+29",
        );
        strictEqual(
            BigDecimal.format(BigDecimal.make(12345n, 25)),
        ...
        strictEqual(
            BigDecimal.format(BigDecimal.make(-12345n, 20)),
            "-1.2345e-16",
        );
    });
