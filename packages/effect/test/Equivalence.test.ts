...
describe("Equivalence", () => {
    ...
    it("productMany", () => {
        const eq = Equivalence.productMany(Equivalence.string, [
            Equivalence.string,
        ]);
        assertTrue(eq(["a", "b"], ["a", "b"]));
    ...
    it("combine", () => {
        ...
        const E0: Equivalence.Equivalence<T> = Equivalence.mapInput(
            (x: T) => x[0],
        )(Equivalence.string);
        const E1: Equivalence.Equivalence<T> = Equivalence.mapInput(
            (x: T) => x[1],
        )(Equivalence.number);
    ...
    it("combineMany", () => {
        ...
        const E2: Equivalence.Equivalence<T> = Equivalence.mapInput(
            (x: T) => x[2],
        )(Equivalence.boolean);
