        ...
        fc.assert(
            fc.asyncProperty(eventsArb, async (events) => {
                ...
                strictEqual(
                    pipe(
                        result,
                        Arr.differenceWith(equivalentElements())(events),
                    ).length,
                    0,
                );
                strictEqual(
                    pipe(
                        events,
                        Arr.differenceWith(equivalentElements())(result),
                    ).length,
                    0,
                );
    ...
    it("removeIf", () =>
        fc.assert(
            fc.asyncProperty(eventsArb, predicateArb, async (events, f) => {
                ...
                strictEqual(
                    Arr.differenceWith(equivalentElements())(result, filtered)
                        .length,
                    0,
                );
                strictEqual(
                    Arr.differenceWith(equivalentElements())(filtered, result)
                        .length,
                    0,
                );
        ...
        fc.assert(
            fc.asyncProperty(
                ...
                async ([events, n]) => {
                    ...
                    deepStrictEqual(
                        result,
                        pipe(result, Arr.sort(orderByTime)),
                    );
                },
            ),
        ));
