...
describe("Function", () => {
    it("apply", () => {
        ...
        deepStrictEqual(
            Function.pipe(countArgs, Function.apply("a", "b", "c")),
            3,
        );
    });
    ...
    it("compose", () => {
        ...
        deepStrictEqual(
            Function.compose(String.length, (n) => n * 2)("aaa"),
            6,
        );
    });
    ...
    it("pipe()", () => {
        ...
        deepStrictEqual(
            pipe(2, f, g, f, g, f, g, f, g, f, g, f, g, f, g, f),
            511,
        );
        deepStrictEqual(
