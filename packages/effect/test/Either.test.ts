...
describe("Either", () => {
  ...
  "left": {
    ...
    it("getEquivalence", () => {
        ...
        deepStrictEqual(
            isEquivalent(Either.right(1), Either.left("foo")),
            false,
        );
        deepStrictEqual(
            isEquivalent(Either.left("foo"), Either.left("foo")),
            true,
        );
        deepStrictEqual(
            isEquivalent(Either.left("foo"), Either.left("bar")),
            false,
        );
        deepStrictEqual(
            isEquivalent(Either.left("foo"), Either.right(1)),
            false,
        );
    });
    ...
    it("all", () => {
        ...
        assertRight(Either.all([Either.right(1), Either.right(true)]), [
            1,
            true,
        ]);
        ...
        assertLeft(
            Either.all({ a: Either.right(1), b: Either.left("e") }),
            "e",
        );
    });
