...
describe("Iterable", () => {
    ...
    describe("iterable inputs", () => {
        it("prepend", () => {
            deepStrictEqual(
                pipe([1, 2, 3], Iter.prepend(0), toArray),
                [0, 1, 2, 3],
            );
            deepStrictEqual(pipe([[2]], Iter.prepend([1]), toArray), [
                [1],
                [2],
            ]);
        ...
        it("append", () => {
            deepStrictEqual(
                pipe([1, 2, 3], Iter.append(4), toArray),
                [1, 2, 3, 4],
            );
        ...
        it("scan", () => {
            ...
            deepStrictEqual(
                pipe(new Set([0]), Iter.scan(10, f), toArray),
                [10, 10],
            );
        ...
        it("take", () => {
            ...
            deepStrictEqual(
                pipe([1, 2, 3, 4], Iter.take(10), toArray),
                [1, 2, 3, 4],
            );
            ...
            deepStrictEqual(
                pipe(new Set([1, 2, 3, 4]), Iter.take(0), toArray),
                [],
            );
            // out of bounds
            deepStrictEqual(
        ...
        it("takeWhile", () => {
            ...
            deepStrictEqual(
                pipe([2, 4, 3, 6], Iter.takeWhile(f), toArray),
                [2, 4],
            );
            ...
            deepStrictEqual(
                pipe(new Set<number>(), Iter.takeWhile(f), toArray),
                [],
            );
            deepStrictEqual(
                pipe(new Set([1, 2, 4]), Iter.takeWhile(f), toArray),
                [],
            );
            deepStrictEqual(
        ...
        it("drop", () => {
            ...
            deepStrictEqual(
                pipe(new Set([1, 2]), Iter.drop(0), toArray),
                [1, 2],
            );
            ...
            deepStrictEqual(
                pipe(new Set([1, 2]), Iter.drop(-1), toArray),
                [1, 2],
            );
        });
        ...
        it("intersperse", () => {
            ...
            deepStrictEqual(
                pipe([1, 2], Iter.intersperse(0), toArray),
                [1, 0, 2],
            );
            deepStrictEqual(
            ...
            deepStrictEqual(
                pipe(new Set([]), Iter.intersperse(0), toArray),
                [],
            );
            deepStrictEqual(pipe(new Set([1]), Iter.intersperse(0), toArray), [
                1,
            ]);
            deepStrictEqual(
        ...
        it("dedupeAdjacentWith", () => {
            ...
            deepStrictEqual(
                toArray(dedupeAdjacent([1, 2, 2, 3, 3])),
                [1, 2, 3],
            );
        });
    });
    ...
    it("getSomes", () => {
        ...
        deepStrictEqual(
            toArray(
                Iter.getSomes([Option.some(1), Option.some(2), Option.some(3)]),
            ),
            [1, 2, 3],
        );
        deepStrictEqual(
            toArray(
                Iter.getSomes([Option.some(1), Option.none(), Option.some(3)]),
            ),
            [1, 3],
        );
    });
    ...
    it("groupBy", () => {
        ...
        deepStrictEqual(
            Iter.groupBy((s: string) => `${s.length}`)([
                "foo",
                "bar",
                "foobar",
            ]),
