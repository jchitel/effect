...
describe("effect/internal/schema/util", () => {
    it("ownKeys", () => {
        ...
        deepStrictEqual(util.ownKeys({ a: 1, [a]: 3, b: 2, [b]: 4 }), [
            "a",
            "b",
            a,
            b,
    ...
    describe("formatUnknown", () => {
        ...
        it("should format symbol property signatures", () => {
            strictEqual(
                util.formatUnknown({ [Symbol.for("a")]: 1 }),
                "{Symbol(a):1}",
            );
        });
        ...
        it("Date", () => {
            strictEqual(
                util.formatUnknown(new Date("2024-01-01T00:00:00.000Z")),
