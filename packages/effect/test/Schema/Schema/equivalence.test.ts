...
schema (NeverKeyword): never`),
    ...
    describe("declaration", () => {
        ...
        it("Data", () => {
            const schema = S.DataFromSelf(
                S.Struct({ a: MyString, b: MyNumber }),
            );
            const equivalence = S.equivalence(schema);
        ...
        it("instanceOf", () => {
            const schema = S.instanceOf(URL, {
                equivalence: () =>
                    Equivalence.make((a, b) => a.href === b.href),
            });
            const equivalence = S.equivalence(schema);
    ...
    describe("union", () => {
        ...
        it("discriminated structs", () => {
            ...
            assertFalse(
                equivalence({ tag: "a", a: "a" }, { tag: "a", a: "b" }),
            );
    ...
    describe("struct", () => {
        ...
        it("exact optional property signature", () => {
            const schema = S.Struct({
                ...
                b: S.optionalWith(S.Union(MyNumber, S.Undefined), {
                    exact: true,
                }),
            });
            const equivalence = S.equivalence(schema);
