...
describe("PubSub", () => {
    ...
    it.effect(
        "dropping concurrent publishers and subscribers - one to one",
        () =>
            Effect.gen(function* () {
                const values = Array.range(0, 64);
                const deferred = yield* Deferred.make<void>();
    ...
    it.effect(
        "sliding concurrent publishers and subscribers - one to one",
        () =>
            Effect.gen(function* () {
                const values = Array.range(0, 64);
                const deferred = yield* Deferred.make<void>();
    ...
    it.effect(
        "sliding concurrent publishers and subscribers - one to many",
        () =>
            Effect.gen(function* () {
                const values = Array.range(0, 64);
                const deferred1 = yield* Deferred.make<void>();
                        ...
                        Effect.gen(function* () {
                            ...
                            deepStrictEqual(
                                Chunk.toReadonlyArray(
                                    yield* Queue.takeUpTo(dequeue1, 2),
                                ),
                                [3, 4],
                            );
                            deepStrictEqual(
                            ...
                            deepStrictEqual(
                                Chunk.toReadonlyArray(
                                    yield* Queue.takeUpTo(dequeue2, 3),
                                ),
                                [4, 5, 6],
                            );
                        }),
