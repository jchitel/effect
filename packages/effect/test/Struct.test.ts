...
describe("Struct", () => {
    it("pick", () => {
        deepStrictEqual(
            pipe({ a: "a", b: 1, c: true }, Struct.pick("a", "b")),
            { a: "a", b: 1 },
        );
        ...
        deepStrictEqual(pipe(optionalSymbolStruct1, Struct.pick(a, "b")), {
            b: 1,
        });
    ...
    it("omit", () => {
        ...
        deepStrictEqual(pipe(optionalStringStruct1, Struct.omit("c")), {
            b: 1,
        });
        const optionalStringStruct2: {
            a?: string;
        ...
        deepStrictEqual(pipe(optionalSymbolStruct1, Struct.omit("c")), {
            b: 1,
        });
        const optionalSymbolStruct2: {
            [a]?: string;
