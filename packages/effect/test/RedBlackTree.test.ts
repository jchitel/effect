...
describe("RedBlackTree", () => {
  ...
  "values": [
    ...
    it("findAll", () => {
        ...
        deepStrictEqual(Array.from(RedBlackTree.findAll(1)(tree)), [
            "a",
            "b",
            "e",
        ]);
    ...
    it("findAll Eq/Ord", () => {
        ...
        deepStrictEqual(
            Array.from(RedBlackTree.findAll(new Key(1, "0"))(tree)),
            ["a", "e", "f"],
        );
        deepStrictEqual(
            Array.from(
                RedBlackTree.values(
                    RedBlackTree.removeFirst(new Key(1, "1"))(tree),
                ),
            ),
            ["f", "e", "b", "a", "c", "d"],
        );
        deepStrictEqual(
            Array.from(
                RedBlackTree.values(
                    RedBlackTree.removeFirst(new Key(1, "0"))(tree),
                ),
            ),
            ["g", "f", "e", "b", "c", "d"],
        );
