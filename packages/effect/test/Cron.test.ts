...
describe("Cron", () => {
    ...
    it("match", () => {
        ...
        assertTrue(
            match(Cron.unsafeParse("15 14 1 * *", london), amsterdamTime),
        );
    });
    ...
    it("sequence", () => {
        ...
        const generator = Cron.sequence(
            Cron.unsafeParse("23 0-20/2 * * 0"),
            start,
        );
        deepStrictEqual(
        ...
        deepStrictEqual(
            generator.next().value,
            new Date("2024-01-07 02:23:00"),
        );
        deepStrictEqual(
            generator.next().value,
            new Date("2024-01-07 04:23:00"),
        );
        deepStrictEqual(
            generator.next().value,
            new Date("2024-01-07 06:23:00"),
        );
        deepStrictEqual(
            generator.next().value,
            new Date("2024-01-07 08:23:00"),
        );
    });
