 ...
 * @category symbols
 */
export const FrequencyStateTypeId: unique symbol =
    internal.FrequencyStateTypeId;
 ...
 * @category symbols
 */
export const HistogramStateTypeId: unique symbol =
    internal.HistogramStateTypeId;
...
export interface MetricState<in A>
    extends MetricState.Variance<A>,
        Equal.Equal,
        Pipeable {}
...
export declare namespace MetricState {
    ...
    export interface Frequency
        extends MetricState<MetricKeyType.MetricKeyType.Frequency> {
     ...
     * @category models
     */
    export interface Gauge<in out A extends number | bigint>
        extends MetricState<MetricKeyType.MetricKeyType.Gauge<A>> {
    ...
    export interface Histogram
        extends MetricState<MetricKeyType.MetricKeyType.Histogram> {
    ...
    export interface Summary
        extends MetricState<MetricKeyType.MetricKeyType.Summary> {
