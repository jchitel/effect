...
export const getJSONSchemaUnsupportedKeyErrorMessage = (
    ...
    getErrorMessage(
        "Unsupported key",
        `Cannot encode ${util_.formatPropertyKey(key)} key to JSON Schema`,
        path,
    );
...
export const getPrettyNoMatchingSchemaErrorMessage = (
    ...
    getErrorMessage(
        "Unexpected Error",
        `Cannot find a matching schema for ${util_.formatUnknown(actual)}`,
        path,
        ast,
    );
...
export const getASTUnsupportedLiteralErrorMessage = (
    ...
    getErrorMessage(
        "Unsupported literal",
        `literal value: ${util_.formatUnknown(literal)}`,
    );
...
export const getASTDuplicatePropertySignatureTransformationErrorMessage = (
    ...
    getErrorMessage(
        ...
        `Duplicate key ${util_.formatUnknown(key)}`,
    );
