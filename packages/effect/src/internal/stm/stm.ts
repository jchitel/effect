...
const loopLoop = <Z, A, E, R>(
    ...
    if (cont(initial)) {
        return pipe(
            ...
            core.flatMap((a) =>
                pipe(
                    loopLoop(inc(initial), cont, inc, body),
                    core.map(Chunk.append(a)),
                ),
            ),
        );
    }
    ...
    <A, E, R, A2, E2, R2>(
        ...
        core.flatMap(
            ...
            (reset) =>
                pipe(
                    core.orTry(self, () =>
                        core.flatMap(core.sync(reset), that),
                    ),
...
>(
    ...
    <A, E, R, A2, E2, R2>(
        ...
        orElse(core.map(self, Either.left), () =>
            core.map(that(), Either.right),
        ),
);
...
>(2, (self, { onFailure, onSuccess }) =>
    core.matchSTM(self, {
        onFailure: (e) =>
            pipe(onFailure(e as any), core.zipRight(core.fail(e))),
