...
/** @internal */
export class Zip<out T0, out T1>
    implements Supervisor.Supervisor<readonly [T0, T1]>
{
    readonly _tag = "Zip";
    readonly [SupervisorTypeId] = supervisorVariance;
...
/** @internal */
export class Track
    implements Supervisor.Supervisor<Array<Fiber.RuntimeFiber<any, any>>>
{
    readonly [SupervisorTypeId] = supervisorVariance;
        ...
        Supervisor.Supervisor<SortedSet.SortedSet<Fiber.RuntimeFiber<any, any>>>
{
    ...
    onStart<A, E, R>(
        ...
        pipe(
            this.ref,
            MutableRef.set(
                pipe(MutableRef.get(this.ref), SortedSet.add(fiber)),
            ),
        );
    }
    ...
    onEnd<A, E>(
        ...
        pipe(
            this.ref,
            MutableRef.set(
                pipe(MutableRef.get(this.ref), SortedSet.remove(fiber)),
            ),
        );
    }
