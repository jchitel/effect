...
/** @internal */
class CounterKeyType<A extends number | bigint>
    implements MetricKeyType.MetricKeyType.Counter<A>
{
...
/** @internal */
class GaugeKeyType<A extends number | bigint>
    implements MetricKeyType.MetricKeyType.Gauge<A>
{
    readonly [MetricKeyTypeTypeId] = metricKeyTypeVariance;
...
export class HistogramKeyType implements MetricKeyType.MetricKeyType.Histogram {
    ...
    [Equal.symbol](that: unknown): boolean {
        return (
            isHistogramKey(that) &&
            Equal.equals(this.boundaries, that.boundaries)
        );
    }
    pipe() {
        return pipeArguments(this, arguments);
