...
/** @internal */
class CounterState<A extends number | bigint>
    implements MetricState.MetricState.Counter<A>
{
...
class FrequencyState implements MetricState.MetricState.Frequency {
    ...
    [Hash.symbol](): number {
        return pipe(
            ...
            Hash.combine(
                Hash.array(Arr.fromIterable(this.occurrences.entries())),
            ),
            Hash.cached(this),
        );
    }
...
/** @internal */
class GaugeState<A extends number | bigint>
    implements MetricState.MetricState.Gauge<A>
{
    readonly [MetricStateTypeId] = metricStateVariance;
    readonly [GaugeStateTypeId]: MetricState.GaugeStateTypeId =
        GaugeStateTypeId;
