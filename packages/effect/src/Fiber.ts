 ...
 * @since 3.8.0
 */
export interface FiberUnify<A extends { [Unify.typeSymbol]?: any }>
    extends Effect.EffectUnify<A> {
    Fiber?: () => A[Unify.typeSymbol] extends
        | Fiber<infer A0, infer E0>
        | infer _
        ? Fiber<A0, E0>
        : never;
}
 ...
 * @since 3.8.0
 */
export interface RuntimeFiberUnify<A extends { [Unify.typeSymbol]?: any }>
 ...
 * @category instances
 */
export const Order: order.Order<RuntimeFiber<unknown, unknown>> =
    internal.Order;
...
export const interruptAsFork: {
    (
        fiberId: FiberId.FiberId,
    ): <A, E>(self: Fiber<A, E>) => Effect.Effect<void>;
...
export const zipLeft: {
    <A2, E2>(
        that: Fiber<A2, E2>,
    ): <A, E>(self: Fiber<A, E>) => Fiber<A, E2 | E>;
...
export const zipRight: {
    <A2, E2>(
        that: Fiber<A2, E2>,
    ): <A, E>(self: Fiber<A, E>) => Fiber<A2, E2 | E>;
