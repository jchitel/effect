 ...
 * @category symbols
 */
export const CounterKeyTypeTypeId: unique symbol =
    internal.CounterKeyTypeTypeId;
 ...
 * @category symbols
 */
export const SummaryKeyTypeTypeId: unique symbol =
    internal.SummaryKeyTypeTypeId;
