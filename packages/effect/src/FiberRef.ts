 ...
 * @since 3.8.0
 */
export interface FiberRefUnify<A extends { [Unify.typeSymbol]?: any }>
...
export const getAndUpdateSome: {
    ...
    ): (self: FiberRef<A>) => Effect.Effect<A>;
...
export const modify: {
    <A, B>(
        f: (a: A) => readonly [B, A],
    ): (self: FiberRef<A>) => Effect.Effect<B>;
 ...
 * @category fiberRefs
 */
export const currentLogLevel: FiberRef<LogLevel.LogLevel> =
 ...
 * @category fiberRefs
 */
export const currentTracerEnabled: FiberRef<boolean> =
    core.currentTracerEnabled;
