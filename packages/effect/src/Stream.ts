...
export const distributedWithDynamic: {
    <A>(options: {
        ...
        readonly decide: (
            a: A,
        ) => Effect.Effect<Predicate<number>, never, never>;
    }): <E, R>(
        self: Stream<A, E, R>,
    ) => Effect.Effect<
        Effect.Effect<
        ...
        options?:
            | {
                  readonly haltStrategy?:
                      | HaltStrategy.HaltStrategyInput
                      | undefined;
              }
            | undefined,
    ): <A, E, R>(self: Stream<A, E, R>) => Stream<A2 | A, E2 | E, R2 | R>;
...
export const orElseFail: {
    <E2>(
        error: LazyArg<E2>,
    ): <A, E, R>(self: Stream<A, E, R>) => Stream<A, E2, R>;
...
export const repeatEither: {
    <B, R2>(
        ...
        self: Stream<A, E, R>,
    ) => Stream<Either.Either<A, B>, E, R2 | R>;
    <A, E, R, B, R2>(
        self: Stream<A, E, R>,
        schedule: Schedule.Schedule<B, unknown, R2>,
