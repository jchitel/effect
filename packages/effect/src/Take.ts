 ...
 * @category getters
 */
export const isFailure: <A, E>(self: Take<A, E>) => boolean =
    internal.isFailure;
 ...
 * @category getters
 */
export const isSuccess: <A, E>(self: Take<A, E>) => boolean =
    internal.isSuccess;
...
export const matchEffect: {
    <Z, E2, R, E, Z2, R2, A, Z3, E3, R3>(options: {
        ...
        readonly onFailure: (
            cause: Cause.Cause<E>,
        ) => Effect.Effect<Z2, E2, R2>;
        readonly onSuccess: (
            chunk: Chunk.Chunk<A>,
        ) => Effect.Effect<Z3, E3, R3>;
    }): (
        self: Take<A, E>,
