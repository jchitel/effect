 ...
 * @category models
 */
export interface STMUnify<A extends { [Unify.typeSymbol]?: any }>
 ...
 * @category constructors
 */
export const attempt: <A>(evaluate: LazyArg<A>) => STM<A, unknown> =
    stm.attempt;
...
export const orDieWith: {
    <E>(
        f: (error: E) => unknown,
    ): <A, R>(self: STM<A, E, R>) => STM<A, never, R>;
