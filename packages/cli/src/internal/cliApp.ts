    ...
    switch (builtIn._tag) {
        ...
        case "ShowCompletions": {
            ...
            switch (builtIn.shellType) {
                case "bash": {
                    return InternalCommand.getBashCompletions(
                        self.command,
                        command,
                    ).pipe(
                ...
                case "fish": {
                    return InternalCommand.getFishCompletions(
                        self.command,
                        command,
                    ).pipe(
                        Effect.flatMap((completions) =>
                ...
                case "zsh":
                    return InternalCommand.getZshCompletions(
                        self.command,
                        command,
                    ).pipe(
                        Effect.flatMap((completions) =>
        ...
        case "ShowWizard": {
            ...
            return Console.log(text).pipe(
                ...
                Effect.tap((args) =>
                    Console.log(
                        InternalHelpDoc.toAnsiText(renderWizardArgs(args)),
                    ),
                ),
                Effect.flatMap((args) =>
