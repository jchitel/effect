 ...
 */
export const getHelp: <A>(self: Options<A>) => HelpDoc =
    InternalOptions.getHelp;
 ...
 * @category combinators
 */
export const getUsage: <A>(self: Options<A>) => Usage =
    InternalOptions.getUsage;
...
export const atLeast: {
    ...
    <A>(self: Options<A>, times: number): Options<Arr.NonEmptyArray<A>>;
