...
export const config: Config.Config<ShardingConfig["Type"]> = Config.all({
    runnerAddress: Config.all({
        ...
        port: Config.integer("port").pipe(
            ...
            Config.withDescription(
                "The port used for inter-runner communication.",
            ),
        ),
    }).pipe(
    ...
    shardManagerUnavailableTimeout: Config.duration(
        "shardManagerUnavailableTimeout",
    ).pipe(
    ...
    entityMessagePollInterval: Config.duration(
