...
describe("Terminal", () => {
    ...
    describe("Commands", () => {
        ...
        it("should move the cursor to the specified row and column", () => {
            ...
            expect(render(Doc.cursorTo(1, 1))).toBe(
                "\u001b[0m\u001b[2;2H\u001b[0m",
            );
        });
        ...
        it("should save the current cursor position", () => {
            expect(render(Doc.cursorSavePosition)).toBe(
                "\u001b[0m\u001b[s\u001b[0m",
            );
        });
        ...
        it("should move the cursor down to the beginning of the next row specified", () => {
            expect(render(Doc.cursorNextLine())).toBe(
                "\u001b[0m\u001b[1E\u001b[0m",
            );
            expect(render(Doc.cursorNextLine(2))).toBe(
                "\u001b[0m\u001b[2E\u001b[0m",
            );
        });

        it("should move the cursor up to the beginning of the previous row specified", () => {
            expect(render(Doc.cursorPrevLine())).toBe(
                "\u001b[0m\u001b[1F\u001b[0m",
            );
            expect(render(Doc.cursorPrevLine(2))).toBe(
                "\u001b[0m\u001b[2F\u001b[0m",
            );
        });

        it("should hide the cursor", () => {
            expect(render(Doc.cursorHide)).toBe(
                "\u001b[0m\u001b[?25l\u001b[0m",
            );
        });

        it("should show the cursor", () => {
            expect(render(Doc.cursorShow)).toBe(
                "\u001b[0m\u001b[?25h\u001b[0m",
            );
        });
