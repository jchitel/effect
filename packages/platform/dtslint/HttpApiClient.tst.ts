...
describe("HttpApiClient", () => {
    it("endpoint", () => {
        Effect.gen(function* () {
            ...
            >().type.toBe<never>();
            expect<
                Effect.Effect.Context<typeof clientEndpointEffect>
            >().type.toBe<
                | "ApiErrorR"
                | "Group1ErrorR"
                | "EndpointAErrorR"
    ...
    it("group", () => {
        Effect.gen(function* () {
            ...
            expect<
                Effect.Effect.Error<typeof clientGroupEffect>
            >().type.toBe<never>();
    ...
    it("make", () => {
        Effect.gen(function* () {
            ...
            expect<
                Effect.Effect.Error<typeof clientApiEffect>
            >().type.toBe<never>();
            ...
            expect(
                clientApi.Group1.EndpointA({ withResponse: false }),
            ).type.toBe<
                Effect.Effect<
                    "EndpointASuccess",
                    | "ApiError"
