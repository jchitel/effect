...
export const makeConfig = (
    ...
    Effect.withFiberRuntime((fiber) => {
        ...
        return Effect.succeed<MP.BaseConfig>({
            ...
            maxFieldSize: Number(
                Context.get(fiber.currentContext, MaxFieldSize),
            ),
            ...
            isFile:
                mimeTypes.length === 0
                    ...
                    : (info: MP.PartInfo): boolean =>
                          !Chunk.some(mimeTypes, (_) =>
                              info.contentType.includes(_),
...
class FileImpl extends PartBase implements File {
    ...
    constructor(
        ...
        this.contentEffect = channel.pipe(
            ...
            Effect.mapError(
                (cause) =>
                    new MultipartError({ reason: "InternalError", cause }),
            ),
        );
    }
    ...
    <A, E, R>(
        ...
        options: {
            ...
            readonly maxFileSize?:
                | Option.Option<FileSystem.SizeInput>
                | undefined;
...
export class FieldMimeTypes extends Context.Reference<FieldMimeTypes>()(
    ...
    {
        defaultValue: constant<Chunk.Chunk<string>>(
            Chunk.make("application/json"),
        ),
    },
) {}
