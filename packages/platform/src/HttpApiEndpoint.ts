...
> extends Pipeable {
    ...
    readonly urlParamsSchema: Option.Option<
        Schema.Schema<UrlParams, unknown, R>
    >;
...
export declare namespace HttpApiEndpoint {
    ...
    export type ExcludeName<
        ...
        Name extends string,
    > = Exclude<Endpoints, { readonly name: Name }>;
    ...
    >(
        ...
        Name,
        Method,
        Schemas["length"] extends 0
            ? never
            : Types.Simplify<ExtractPath<Schemas>>,
        never,
        never,
        never,
        void,
