    ...
    describe("fromApi", () => {
                ...
                const api = HttpApi.make("api")
                    ...
                    .add(
                        HttpApiGroup.make("group2").add(
                            HttpApiEndpoint.get("getB", "/b").addSuccess(
                                Schema.String,
                            ),
                        ),
                    )
        ...
        describe("HttpGroup", () => {
            ...
            it("annotate", () => {
                const api = HttpApi.make("api")
                    ...
                    .add(
                        HttpApiGroup.make("excluded").annotate(
                            OpenApi.Exclude,
                            true,
                        ),
                    );
        ...
        describe("HttpApiEndpoint.get", () => {
            ...
            it("setPath as template string", () => {
                ...
                const b = Schema.String.annotations({
                    description: "my description",
                });
                const api = HttpApi.make("api").add(
                    HttpApiGroup.make("group").add(
                        HttpApiEndpoint.get("get")`/a/${a}/b/${b}`.addSuccess(
                            Schema.String,
                        ),
                    ),
                );
            ...
            describe("addSError + withEncoding", () => {
                it("HttpApiSchema.Text()", () => {
                    const api = HttpApi.make("api").add(
                        HttpApiGroup.make("group").add(
                            HttpApiEndpoint.get("get", "/").addError(
                                HttpApiSchema.Text(),
                            ),
                        ),
                    );
                    ...
                    HttpApiGroup.make("group")
                        .add(
                            HttpApiEndpoint.get("get", "/")
                                ...
                                .annotate(OpenApi.Override, {
                                    operationId: "my operationId",
                                })
                                .annotate(OpenApi.Transform, (spec) => ({
                                    ...spec,
                                    operationId:
                                        spec.operationId + "-transformed",
                                })),
                        )
                        .add(
            ...
            it("Security Middleware", () => {
                ...
                class Resource extends Context.Tag("Resource")<
                    Resource,
                    string
                >() {}
                ...
                class Authorization extends HttpApiMiddleware.Tag<Authorization>()(
                    "Authorization",
                    {
                        ...
                        security: {
                            ...
                            myApiKey: HttpApiSecurity.apiKey({
                                in: "cookie",
                                key: "mykey",
                            }),
        ...
        describe("HttpApiEndpoint.del", () => {
            it("addSuccess", () => {
                const api = HttpApi.make("api").add(
                    HttpApiGroup.make("group").add(
                        HttpApiEndpoint.del("del", "/").addSuccess(
                            Schema.String,
                        ),
                    ),
                );
