            ...
            switch (self._tag) {
                ...
                case "Cat": {
                    ...
                    if (
                        ...
                        InternalDoc.isChar(self.right)
                    ) {
                        return InternalDoc.text(
                            self.left.char + self.right.char,
                        );
                    }
                    if (
                        ...
                        return InternalDoc.text(
                            self.left.text + self.right.char,
                        );
                    }
                    if (
                        InternalDoc.isChar(self.left) &&
                        InternalDoc.isText(self.right)
                    ) {
                        return InternalDoc.text(
                            self.left.char + self.right.text,
                        );
                    }
                    if (
                        InternalDoc.isText(self.left) &&
                    ...
                    if (
                        ...
                        return yield* optimize(
                            InternalDoc.cat(inner, self.right.right),
                        );
                    }
                    // Nested Documents
                    if (
                        ...
                        return yield* optimize(
                            InternalDoc.cat(self.left.left, inner),
                        );
                    }
                    // Otherwise
                    const left = yield* optimize(self.left);
                ...
                case "Nest": {
                    ...
                    if (InternalDoc.isNest(self.doc)) {
                        ...
                        return yield* optimize(
                            InternalDoc.nest(self.doc.doc, indent),
                        );
                    }
                    return InternalDoc.nest(
                ...
                case "Column": {
                    return depth._tag === "Shallow"
                        ...
                        : InternalDoc.column((position) =>
                              Effect.runSync(
                                  optimizeSafe(self.react(position), depth),
                              ),
                          );
                }
                case "WithPageWidth": {
                    return depth._tag === "Shallow"
                        ...
                        : InternalDoc.pageWidth((pageWidth) =>
                              Effect.runSync(
                                  optimizeSafe(self.react(pageWidth), depth),
                              ),
                          );
                }
                case "Nesting": {
                    return depth._tag === "Shallow"
                        ...
                        : InternalDoc.nesting((level) =>
                              Effect.runSync(
                                  optimizeSafe(self.react(level), depth),
                              ),
                          );
                }
                case "Annotated": {
