 ...
 * @category models
 */
export interface Procedure<Request extends TaggedRequest.Any, State, R>
    extends Pipeable {
...
export declare namespace Procedure {
     ...
     * @category models
     */
    export interface ContextProto<Requests extends TaggedRequest.Any, State>
        extends BaseContext {
        readonly send: <Req extends Requests>(
            request: Req,
        ) => Effect.Effect<void>;
