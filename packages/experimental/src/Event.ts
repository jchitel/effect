...
export declare namespace Event {
     ...
     * @category models
     */
    export type PayloadWithTag<
        Events extends Any,
        Tag extends string,
    > = Payload<WithTag<Events, Tag>>;

    /**
     * @since 1.0.0
     * @category models
     */
    export type SuccessWithTag<
        Events extends Any,
        Tag extends string,
    > = Success<WithTag<Events, Tag>>;
     ...
     * @category models
     */
    export type ContextWithTag<
        Events extends Any,
        Tag extends string,
    > = Context<WithTag<Events, Tag>>;
}
