    ...
    Effect.gen(function* () {
        ...
        const spanAttributes: ReadonlyArray<[string, unknown]> = [
            ...
            [
                ...
                OtelSemConv.DB_SYSTEM_NAME_VALUE_MICROSOFT_SQL_SERVER,
            ],
        ...
        yield* pool.get.pipe(
            ...
            Effect.mapError(
                ({ cause }) =>
                    new SqlError({
                        cause,
                        message: "MssqlClient: Failed to connect",
                    }),
            ),
            Effect.scoped,
            Effect.timeoutFail({
                        ...
                        const client = Object.assign(
                            ...
                            statement,
                            {
                                call: <
                                    ...
                                    A,
                                >(
                                    procedure: Procedure.ProcedureWithValues<
                                        I,
                                        O,
                                        A
                                    >,
